...
Source0  : https://files.pythonhosted.org/packages/cf/1d/340d779a0696f1a6e4a8fbfd2e1b2fa2b1752743d603b6977595fdb48c72/awscli-1.25.30.tar.gz
...
%prep
%setup -q -n awscli-1.25.30
cd %{_builddir}/awscli-1.25.30
%patch1 -p1
pushd ..
cp -a awscli-1.25.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657827457
...
cp %{_builddir}/awscli-1.25.30/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
