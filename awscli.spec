...
Source0  : https://files.pythonhosted.org/packages/db/ac/789329b07f812aeb0d2e323a9855e9ee85f91eb63d2e3ffe001f6610e100/awscli-1.27.90.tar.gz
...
%prep
%setup -q -n awscli-1.27.90
cd %{_builddir}/awscli-1.27.90
%patch1 -p1
pushd ..
cp -a awscli-1.27.90 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678736675
