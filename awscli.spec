...
Version  : 1.25.6
Release  : 1107
URL      : https://files.pythonhosted.org/packages/48/bd/4ee78d0373a534040df1f669178b4daf963c12abe82338ed9a73c2797feb/awscli-1.25.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/48/bd/4ee78d0373a534040df1f669178b4daf963c12abe82338ed9a73c2797feb/awscli-1.25.6.tar.gz
...
%prep
%setup -q -n awscli-1.25.6
cd %{_builddir}/awscli-1.25.6
%patch1 -p1
pushd ..
cp -a awscli-1.25.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654804239
...
cp %{_builddir}/awscli-1.25.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
