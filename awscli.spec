...
Version  : 1.25.75
Release  : 1180
URL      : https://files.pythonhosted.org/packages/cc/25/3ca035128d5853b1d1c9644c90d008338b249820cc548970c7ea1d3eedde/awscli-1.25.75.tar.gz
Source0  : https://files.pythonhosted.org/packages/cc/25/3ca035128d5853b1d1c9644c90d008338b249820cc548970c7ea1d3eedde/awscli-1.25.75.tar.gz
...
%prep
%setup -q -n awscli-1.25.75
cd %{_builddir}/awscli-1.25.75
%patch1 -p1
pushd ..
cp -a awscli-1.25.75 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663271554
