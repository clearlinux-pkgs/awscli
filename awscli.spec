...
Version  : 1.26.4
Release  : 1209
URL      : https://files.pythonhosted.org/packages/46/e7/1ecf7a09cbf37c84e5580cef74778c06cca839a4d1520066ec11832dfe9c/awscli-1.26.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/46/e7/1ecf7a09cbf37c84e5580cef74778c06cca839a4d1520066ec11832dfe9c/awscli-1.26.4.tar.gz
...
%prep
%setup -q -n awscli-1.26.4
cd %{_builddir}/awscli-1.26.4
%patch1 -p1
pushd ..
cp -a awscli-1.26.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666985917
