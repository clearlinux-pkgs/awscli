...
Source0  : https://files.pythonhosted.org/packages/4a/db/52ad6e83beab539244d5d34a90fd057c0da45f222e1a4256e2f7f3e45034/awscli-1.20.43.tar.gz
...
%prep
%setup -q -n awscli-1.20.43
cd %{_builddir}/awscli-1.20.43
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631890112
...
cp %{_builddir}/awscli-1.20.43/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
