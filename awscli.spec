...
Version  : 1.25.13
Release  : 1114
URL      : https://files.pythonhosted.org/packages/96/d2/44f5274026c8ed1aab3a2b882324c8f3334f285485c253a12f5f30a87665/awscli-1.25.13.tar.gz
Source0  : https://files.pythonhosted.org/packages/96/d2/44f5274026c8ed1aab3a2b882324c8f3334f285485c253a12f5f30a87665/awscli-1.25.13.tar.gz
...
%prep
%setup -q -n awscli-1.25.13
cd %{_builddir}/awscli-1.25.13
%patch1 -p1
pushd ..
cp -a awscli-1.25.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655753848
...
cp %{_builddir}/awscli-1.25.13/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
