...
Version  : 1.25.69
Release  : 1174
URL      : https://files.pythonhosted.org/packages/06/50/9e09a6b3ee4233578ccee531de8aad5a2edcb4eed0988813172b25cfba74/awscli-1.25.69.tar.gz
Source0  : https://files.pythonhosted.org/packages/06/50/9e09a6b3ee4233578ccee531de8aad5a2edcb4eed0988813172b25cfba74/awscli-1.25.69.tar.gz
...
%prep
%setup -q -n awscli-1.25.69
cd %{_builddir}/awscli-1.25.69
%patch1 -p1
pushd ..
cp -a awscli-1.25.69 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662591184
