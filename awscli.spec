...
Source0  : https://files.pythonhosted.org/packages/ec/45/b37d367fb6bb70ea24850bac1b182be9f79098c37fe548217ac0c1e85e81/awscli-1.27.140.tar.gz
...
%prep
%setup -q -n awscli-1.27.140
cd %{_builddir}/awscli-1.27.140
%patch1 -p1
pushd ..
cp -a awscli-1.27.140 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684968621
