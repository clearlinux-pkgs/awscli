...
Source0  : https://files.pythonhosted.org/packages/12/db/fd16a26e6b56132841f99e970e800e25f6f6faa4b9affb0024b55793ac77/awscli-1.27.0.tar.gz
...
%prep
%setup -q -n awscli-1.27.0
cd %{_builddir}/awscli-1.27.0
%patch1 -p1
pushd ..
cp -a awscli-1.27.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667343029
