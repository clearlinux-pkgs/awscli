...
Version  : 1.18.12
Release  : 571
URL      : https://files.pythonhosted.org/packages/4a/52/f2f7dd1ed6106bc3e95c729130891841673b88e24759228649bc932ff245/awscli-1.18.12.tar.gz
Source0  : https://files.pythonhosted.org/packages/4a/52/f2f7dd1ed6106bc3e95c729130891841673b88e24759228649bc932ff245/awscli-1.18.12.tar.gz
...
%prep
%setup -q -n awscli-1.18.12
cd %{_builddir}/awscli-1.18.12
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583247524
...
cp %{_builddir}/awscli-1.18.12/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
