...
Version  : 1.20.34
Release  : 917
URL      : https://files.pythonhosted.org/packages/99/8d/075a5ceebf1f4b9306e39df428443681bf81af0fb53e341a9b20d5c44261/awscli-1.20.34.tar.gz
Source0  : https://files.pythonhosted.org/packages/99/8d/075a5ceebf1f4b9306e39df428443681bf81af0fb53e341a9b20d5c44261/awscli-1.20.34.tar.gz
...
%prep
%setup -q -n awscli-1.20.34
cd %{_builddir}/awscli-1.20.34
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630551601
...
cp %{_builddir}/awscli-1.20.34/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
