...
Source0  : https://files.pythonhosted.org/packages/0c/56/23912475a6e41f9c174bf6e206845a77a5a1f49a405caa8511cbe1040c3b/awscli-1.25.80.tar.gz
...
%prep
%setup -q -n awscli-1.25.80
cd %{_builddir}/awscli-1.25.80
%patch1 -p1
pushd ..
cp -a awscli-1.25.80 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663876182
