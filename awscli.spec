...
%prep
%setup -q -n awscli-1.22.24
cd %{_builddir}/awscli-1.22.24
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639440099
...
cp %{_builddir}/awscli-1.22.24/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
