...
Version  : 1.19.54
Release  : 829
URL      : https://files.pythonhosted.org/packages/e0/57/de3d1c329bf7dc908e614a7342742b7a968e70ed10ed212385a199698ff3/awscli-1.19.54.tar.gz
Source0  : https://files.pythonhosted.org/packages/e0/57/de3d1c329bf7dc908e614a7342742b7a968e70ed10ed212385a199698ff3/awscli-1.19.54.tar.gz
...
%prep
%setup -q -n awscli-1.19.54
cd %{_builddir}/awscli-1.19.54
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618927498
...
cp %{_builddir}/awscli-1.19.54/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
