...
Version  : 1.24.7
Release  : 1097
URL      : https://files.pythonhosted.org/packages/9e/25/f9bd32895318cc3ee09ac4daddd53d7c56c3ede1d106035feac8982c95cb/awscli-1.24.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/9e/25/f9bd32895318cc3ee09ac4daddd53d7c56c3ede1d106035feac8982c95cb/awscli-1.24.7.tar.gz
...
%prep
%setup -q -n awscli-1.24.7
cd %{_builddir}/awscli-1.24.7
%patch1 -p1
pushd ..
cp -a awscli-1.24.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653427336
...
cp %{_builddir}/awscli-1.24.7/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
