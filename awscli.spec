...
Version  : 1.27.52
Release  : 1264
URL      : https://files.pythonhosted.org/packages/3e/e0/a5bb924cb0236778a2a3943dcae384569bcc400a5eac2baad76d7df01397/awscli-1.27.52.tar.gz
Source0  : https://files.pythonhosted.org/packages/3e/e0/a5bb924cb0236778a2a3943dcae384569bcc400a5eac2baad76d7df01397/awscli-1.27.52.tar.gz
...
%prep
%setup -q -n awscli-1.27.52
cd %{_builddir}/awscli-1.27.52
%patch1 -p1
pushd ..
cp -a awscli-1.27.52 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674085429
