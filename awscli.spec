...
Version  : 1.27.41
Release  : 1253
URL      : https://files.pythonhosted.org/packages/f4/2e/9ad0a21095996b71c44a03e4ddb3ae4d4471f1a49c85edad8d5e648e450d/awscli-1.27.41.tar.gz
Source0  : https://files.pythonhosted.org/packages/f4/2e/9ad0a21095996b71c44a03e4ddb3ae4d4471f1a49c85edad8d5e648e450d/awscli-1.27.41.tar.gz
...
%prep
%setup -q -n awscli-1.27.41
cd %{_builddir}/awscli-1.27.41
%patch1 -p1
pushd ..
cp -a awscli-1.27.41 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672433274
