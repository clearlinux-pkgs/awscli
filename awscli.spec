...
Version  : 1.18.222
Release  : 771
URL      : https://files.pythonhosted.org/packages/09/4b/c2acea6f2917e455839b3b256e50b47a495db35a3dad1ee2ec7759791516/awscli-1.18.222.tar.gz
Source0  : https://files.pythonhosted.org/packages/09/4b/c2acea6f2917e455839b3b256e50b47a495db35a3dad1ee2ec7759791516/awscli-1.18.222.tar.gz
...
%prep
%setup -q -n awscli-1.18.222
cd %{_builddir}/awscli-1.18.222
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611876414
...
cp %{_builddir}/awscli-1.18.222/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
