...
Source0  : https://files.pythonhosted.org/packages/df/e7/7ec9fc00cbb7b1ecf7c6d2a3647540ef31edb1cc96c8d90bc09e4a90242b/awscli-1.26.0.tar.gz
...
%prep
%setup -q -n awscli-1.26.0
cd %{_builddir}/awscli-1.26.0
%patch1 -p1
pushd ..
cp -a awscli-1.26.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666660639
