...
Version  : 1.25.16
Release  : 1117
URL      : https://files.pythonhosted.org/packages/d5/a2/e795f3b02c38e2be5888edff606a01a198b8ba77accfbf886373e11be0a2/awscli-1.25.16.tar.gz
Source0  : https://files.pythonhosted.org/packages/d5/a2/e795f3b02c38e2be5888edff606a01a198b8ba77accfbf886373e11be0a2/awscli-1.25.16.tar.gz
...
%prep
%setup -q -n awscli-1.25.16
cd %{_builddir}/awscli-1.25.16
%patch1 -p1
pushd ..
cp -a awscli-1.25.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656024774
...
cp %{_builddir}/awscli-1.25.16/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
