...
Version  : 1.27.62
Release  : 1274
URL      : https://files.pythonhosted.org/packages/89/00/31bd06224b260cde7c50fd55c753697a6dff478ec38248a4f52ef9dba43c/awscli-1.27.62.tar.gz
Source0  : https://files.pythonhosted.org/packages/89/00/31bd06224b260cde7c50fd55c753697a6dff478ec38248a4f52ef9dba43c/awscli-1.27.62.tar.gz
...
%prep
%setup -q -n awscli-1.27.62
cd %{_builddir}/awscli-1.27.62
%patch1 -p1
pushd ..
cp -a awscli-1.27.62 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675283780
