...
Source0  : https://files.pythonhosted.org/packages/28/cf/85c862121eb64d1021b561b567518fa12e8c0c36a74b7c09a6c254f7cd63/awscli-1.27.73.tar.gz
...
%prep
%setup -q -n awscli-1.27.73
cd %{_builddir}/awscli-1.27.73
%patch1 -p1
pushd ..
cp -a awscli-1.27.73 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676579859
