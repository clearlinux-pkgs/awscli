...
Version  : 1.20.4
Release  : 892
URL      : https://files.pythonhosted.org/packages/7b/58/3255c17ad125fa1776692cd5e3ee78f2e412227fe73ee8dab13544d55046/awscli-1.20.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/7b/58/3255c17ad125fa1776692cd5e3ee78f2e412227fe73ee8dab13544d55046/awscli-1.20.4.tar.gz
...
%prep
%setup -q -n awscli-1.20.4
cd %{_builddir}/awscli-1.20.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626898401
...
cp %{_builddir}/awscli-1.20.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
