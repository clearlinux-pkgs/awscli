...
Source0  : https://files.pythonhosted.org/packages/aa/3e/e4edeef9621068e27ce1d4cd10b847f00ef7de1c337ee70fb2ed67b32449/awscli-1.27.4.tar.gz
...
%prep
%setup -q -n awscli-1.27.4
cd %{_builddir}/awscli-1.27.4
%patch1 -p1
pushd ..
cp -a awscli-1.27.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667855895
