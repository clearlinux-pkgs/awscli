...
Version  : 1.25.44
Release  : 1146
URL      : https://files.pythonhosted.org/packages/a0/e1/75efc99f915fee3e825da4aac69a5dd6db26a3575955aea9a3fec847b4af/awscli-1.25.44.tar.gz
Source0  : https://files.pythonhosted.org/packages/a0/e1/75efc99f915fee3e825da4aac69a5dd6db26a3575955aea9a3fec847b4af/awscli-1.25.44.tar.gz
...
%prep
%setup -q -n awscli-1.25.44
cd %{_builddir}/awscli-1.25.44
%patch1 -p1
pushd ..
cp -a awscli-1.25.44 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659469310
