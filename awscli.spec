...
Source0  : https://files.pythonhosted.org/packages/80/e5/ba2049da5880fc52dce8bcaf288a42f955d51b359f6158e3b1c55fb5bb86/awscli-1.27.80.tar.gz
...
%prep
%setup -q -n awscli-1.27.80
cd %{_builddir}/awscli-1.27.80
%patch1 -p1
pushd ..
cp -a awscli-1.27.80 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677530696
