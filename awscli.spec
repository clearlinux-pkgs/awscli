...
Version  : 1.24.1
Release  : 1090
URL      : https://files.pythonhosted.org/packages/4d/ae/6f38923a2f25cbf0f70d10044d4ee3d044c6aa3e144102a43aa73ecafbe9/awscli-1.24.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/4d/ae/6f38923a2f25cbf0f70d10044d4ee3d044c6aa3e144102a43aa73ecafbe9/awscli-1.24.1.tar.gz
...
%prep
%setup -q -n awscli-1.24.1
cd %{_builddir}/awscli-1.24.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652732891
...
cp %{_builddir}/awscli-1.24.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
