...
Source0  : https://files.pythonhosted.org/packages/e0/8f/068476683a9ff258cf9664c614aa0b48380607d4f99637b42ee7f9ea9aef/awscli-1.27.30.tar.gz
...
%prep
%setup -q -n awscli-1.27.30
cd %{_builddir}/awscli-1.27.30
%patch1 -p1
pushd ..
cp -a awscli-1.27.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671050614
