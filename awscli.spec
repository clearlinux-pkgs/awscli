...
Source0  : https://files.pythonhosted.org/packages/ed/91/bf0cf6451724d3e7693f288441268ced94ebe01938c9a4a23b2f644b355c/awscli-1.27.60.tar.gz
...
%prep
%setup -q -n awscli-1.27.60
cd %{_builddir}/awscli-1.27.60
%patch1 -p1
pushd ..
cp -a awscli-1.27.60 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675122898
