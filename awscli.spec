...
Version  : 1.27.45
Release  : 1257
URL      : https://files.pythonhosted.org/packages/47/a0/8bf05bd5351e18fecd719b5a21548f762ff0b49fd1c6225028a4386132f8/awscli-1.27.45.tar.gz
Source0  : https://files.pythonhosted.org/packages/47/a0/8bf05bd5351e18fecd719b5a21548f762ff0b49fd1c6225028a4386132f8/awscli-1.27.45.tar.gz
...
%prep
%setup -q -n awscli-1.27.45
cd %{_builddir}/awscli-1.27.45
%patch1 -p1
pushd ..
cp -a awscli-1.27.45 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673038122
