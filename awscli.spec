...
Source0  : https://files.pythonhosted.org/packages/f0/83/23008808deafef9fe0d1d09a9a61d0a2811c04bacfc6eae0a90d885c9af4/awscli-1.27.69.tar.gz
...
%prep
%setup -q -n awscli-1.27.69
cd %{_builddir}/awscli-1.27.69
%patch1 -p1
pushd ..
cp -a awscli-1.27.69 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676061838
