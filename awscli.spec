...
Source0  : https://files.pythonhosted.org/packages/31/61/75178dfbbc00cdcf80e59ced73da3de4c91f942b94483b42d10e7fe0bbdd/awscli-1.22.25.tar.gz
...
%prep
%setup -q -n awscli-1.22.25
cd %{_builddir}/awscli-1.22.25
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640033592
...
cp %{_builddir}/awscli-1.22.25/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
