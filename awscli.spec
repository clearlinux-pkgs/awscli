...
Version  : 1.19.8
Release  : 783
URL      : https://files.pythonhosted.org/packages/cc/2d/073d8af1ee82be16107f94a764948ed71059a3b14f7a418a7c6db39e68d6/awscli-1.19.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/cc/2d/073d8af1ee82be16107f94a764948ed71059a3b14f7a418a7c6db39e68d6/awscli-1.19.8.tar.gz
...
%prep
%setup -q -n awscli-1.19.8
cd %{_builddir}/awscli-1.19.8
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613487706
...
cp %{_builddir}/awscli-1.19.8/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
