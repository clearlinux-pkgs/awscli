...
Version  : 1.25.47
Release  : 1148
URL      : https://files.pythonhosted.org/packages/97/f6/a08ae422e85119bfaa26a85642f6db37ee7576dd50b7d9d508318475d0be/awscli-1.25.47.tar.gz
Source0  : https://files.pythonhosted.org/packages/97/f6/a08ae422e85119bfaa26a85642f6db37ee7576dd50b7d9d508318475d0be/awscli-1.25.47.tar.gz
...
%prep
%setup -q -n awscli-1.25.47
cd %{_builddir}/awscli-1.25.47
%patch1 -p1
pushd ..
cp -a awscli-1.25.47 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659988117
