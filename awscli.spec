...
Version  : 1.20.15
Release  : 903
URL      : https://files.pythonhosted.org/packages/a1/f8/46f546a7546e40fd4cf530fc4e30bbb12ccbfcc707a72e8213e07e1c8462/awscli-1.20.15.tar.gz
Source0  : https://files.pythonhosted.org/packages/a1/f8/46f546a7546e40fd4cf530fc4e30bbb12ccbfcc707a72e8213e07e1c8462/awscli-1.20.15.tar.gz
...
%prep
%setup -q -n awscli-1.20.15
cd %{_builddir}/awscli-1.20.15
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628210893
...
cp %{_builddir}/awscli-1.20.15/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
