...
Source0  : https://files.pythonhosted.org/packages/33/97/53fc86d7be8cc7caef5ca9233c420e0fcdfe5b4ea528b402863ebce5caba/awscli-1.22.100.tar.gz
...
%prep
%setup -q -n awscli-1.22.100
cd %{_builddir}/awscli-1.22.100
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650570153
...
cp %{_builddir}/awscli-1.22.100/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
