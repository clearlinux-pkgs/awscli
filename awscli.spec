...
Version  : 1.27.127
Release  : 1339
URL      : https://files.pythonhosted.org/packages/6e/37/d3793f7286e82418e18cfacf7ba12eed3617ee4699662fde6812770e1131/awscli-1.27.127.tar.gz
Source0  : https://files.pythonhosted.org/packages/6e/37/d3793f7286e82418e18cfacf7ba12eed3617ee4699662fde6812770e1131/awscli-1.27.127.tar.gz
...
%prep
%setup -q -n awscli-1.27.127
cd %{_builddir}/awscli-1.27.127
%patch1 -p1
pushd ..
cp -a awscli-1.27.127 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683239893
