...
Source0  : https://files.pythonhosted.org/packages/18/de/c6eebcee4270191be79dae7043386327847a5d1b354d2340e1e8e9d0a6dd/awscli-1.20.40.tar.gz
...
%prep
%setup -q -n awscli-1.20.40
cd %{_builddir}/awscli-1.20.40
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631543481
...
cp %{_builddir}/awscli-1.20.40/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
