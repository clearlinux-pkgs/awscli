...
Version  : 1.18.208
Release  : 757
URL      : https://files.pythonhosted.org/packages/70/b9/960aaa32b8864ccfbeca80ca6d4e9015802891d6a951370334af3cd3bfb3/awscli-1.18.208.tar.gz
Source0  : https://files.pythonhosted.org/packages/70/b9/960aaa32b8864ccfbeca80ca6d4e9015802891d6a951370334af3cd3bfb3/awscli-1.18.208.tar.gz
...
%prep
%setup -q -n awscli-1.18.208
cd %{_builddir}/awscli-1.18.208
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609802531
...
cp %{_builddir}/awscli-1.18.208/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
