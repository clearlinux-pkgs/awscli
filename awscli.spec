...
Source0  : https://files.pythonhosted.org/packages/4f/a0/51a7b7179db3f3dea5a8cae50e6de9e17b052745e5ed14ad515ffcd8ab0d/awscli-1.30.0.tar.gz
...
%prep
%setup -q -n awscli-1.30.0
cd %{_builddir}/awscli-1.30.0
pushd ..
cp -a awscli-1.30.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700004897
