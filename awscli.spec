...
Version  : 1.27.42
Release  : 1254
URL      : https://files.pythonhosted.org/packages/16/76/ec8cc0429ce69e01987e162644cf81eac10de964cea26e14d9aea54aed78/awscli-1.27.42.tar.gz
Source0  : https://files.pythonhosted.org/packages/16/76/ec8cc0429ce69e01987e162644cf81eac10de964cea26e14d9aea54aed78/awscli-1.27.42.tar.gz
...
%prep
%setup -q -n awscli-1.27.42
cd %{_builddir}/awscli-1.27.42
%patch1 -p1
pushd ..
cp -a awscli-1.27.42 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672778887
