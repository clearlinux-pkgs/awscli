...
Version  : 1.23.11
Release  : 1086
URL      : https://files.pythonhosted.org/packages/87/4a/ade732bcad8f023ac38dcf787cd42fec0ce9a067ef7859b8d93d8de1de89/awscli-1.23.11.tar.gz
Source0  : https://files.pythonhosted.org/packages/87/4a/ade732bcad8f023ac38dcf787cd42fec0ce9a067ef7859b8d93d8de1de89/awscli-1.23.11.tar.gz
...
%prep
%setup -q -n awscli-1.23.11
cd %{_builddir}/awscli-1.23.11
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652212078
...
cp %{_builddir}/awscli-1.23.11/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
