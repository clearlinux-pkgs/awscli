...
Source0  : https://files.pythonhosted.org/packages/9f/9b/dff2e720352bc2cec1c075764c86d2fdb39bb43ff3129659da0ffefed5cb/awscli-1.27.27.tar.gz
...
%prep
%setup -q -n awscli-1.27.27
cd %{_builddir}/awscli-1.27.27
%patch1 -p1
pushd ..
cp -a awscli-1.27.27 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670618617
