...
Version  : 1.25.33
Release  : 1134
URL      : https://files.pythonhosted.org/packages/77/6f/c76ea7e61aa2ef34cab1df1b6e1121435f8aa1fc74228edb171c0665da10/awscli-1.25.33.tar.gz
Source0  : https://files.pythonhosted.org/packages/77/6f/c76ea7e61aa2ef34cab1df1b6e1121435f8aa1fc74228edb171c0665da10/awscli-1.25.33.tar.gz
...
%prep
%setup -q -n awscli-1.25.33
cd %{_builddir}/awscli-1.25.33
%patch1 -p1
pushd ..
cp -a awscli-1.25.33 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658259348
...
cp %{_builddir}/awscli-1.25.33/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
