...
Source0  : https://files.pythonhosted.org/packages/36/bb/98d52117a262f84b7baba2f69c2a86990bcb4868e7da4858789135ce9b2f/awscli-1.20.50.tar.gz
...
%prep
%setup -q -n awscli-1.20.50
cd %{_builddir}/awscli-1.20.50
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632860005
...
cp %{_builddir}/awscli-1.20.50/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
