...
Source0  : https://files.pythonhosted.org/packages/b0/c9/4c38e4889fc12e778b8c507d75c0139c25c2b64df1a239473a1989326a79/awscli-1.20.60.tar.gz
...
%prep
%setup -q -n awscli-1.20.60
cd %{_builddir}/awscli-1.20.60
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634130872
...
cp %{_builddir}/awscli-1.20.60/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
