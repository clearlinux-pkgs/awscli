...
Version  : 1.22.34
Release  : 1006
URL      : https://files.pythonhosted.org/packages/d8/9b/0441314dc333f9004968fb8a27a83bdf9c9640be1d1925dd623f27bb15b4/awscli-1.22.34.tar.gz
Source0  : https://files.pythonhosted.org/packages/d8/9b/0441314dc333f9004968fb8a27a83bdf9c9640be1d1925dd623f27bb15b4/awscli-1.22.34.tar.gz
...
%prep
%setup -q -n awscli-1.22.34
cd %{_builddir}/awscli-1.22.34
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642021643
...
cp %{_builddir}/awscli-1.22.34/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
