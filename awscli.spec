...
Version  : 1.20.52
Release  : 933
URL      : https://files.pythonhosted.org/packages/8f/5b/32c3410ffc9d57d9452c83d1be909f596c0d08d0cf3035ae473b000bceb2/awscli-1.20.52.tar.gz
Source0  : https://files.pythonhosted.org/packages/8f/5b/32c3410ffc9d57d9452c83d1be909f596c0d08d0cf3035ae473b000bceb2/awscli-1.20.52.tar.gz
...
%prep
%setup -q -n awscli-1.20.52
cd %{_builddir}/awscli-1.20.52
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633101567
...
cp %{_builddir}/awscli-1.20.52/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
