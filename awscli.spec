...
Source0  : https://files.pythonhosted.org/packages/f8/a6/d027f84540bff9fcb6c4f716564d70e48d1c57b599e22c89e05d3e429032/awscli-1.29.68.tar.gz
...
%prep
%setup -q -n awscli-1.29.68
cd %{_builddir}/awscli-1.29.68
pushd ..
cp -a awscli-1.29.68 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697841773
