...
Version  : 1.25.86
Release  : 1191
URL      : https://files.pythonhosted.org/packages/53/97/0fe79ff112b2c3a0767eee0874b880e636d95887e035ed0a96335d85eb90/awscli-1.25.86.tar.gz
Source0  : https://files.pythonhosted.org/packages/53/97/0fe79ff112b2c3a0767eee0874b880e636d95887e035ed0a96335d85eb90/awscli-1.25.86.tar.gz
...
%prep
%setup -q -n awscli-1.25.86
cd %{_builddir}/awscli-1.25.86
%patch1 -p1
pushd ..
cp -a awscli-1.25.86 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664826661
