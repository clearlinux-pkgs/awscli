...
Version  : 1.19.75
Release  : 850
URL      : https://files.pythonhosted.org/packages/8a/24/7511709dd0b4e1d2958d616c6c55b30054d26fbd3d93f005b89644accd12/awscli-1.19.75.tar.gz
Source0  : https://files.pythonhosted.org/packages/8a/24/7511709dd0b4e1d2958d616c6c55b30054d26fbd3d93f005b89644accd12/awscli-1.19.75.tar.gz
...
%prep
%setup -q -n awscli-1.19.75
cd %{_builddir}/awscli-1.19.75
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621433335
...
cp %{_builddir}/awscli-1.19.75/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
