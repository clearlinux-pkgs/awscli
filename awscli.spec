...
Source0  : https://files.pythonhosted.org/packages/84/3f/a0a22dcdef169fad571391c9b2c7eb242a03c4c3a91c68e0752309ad1e4a/awscli-1.25.40.tar.gz
...
%prep
%setup -q -n awscli-1.25.40
cd %{_builddir}/awscli-1.25.40
%patch1 -p1
pushd ..
cp -a awscli-1.25.40 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659037912
