...
Source0  : https://files.pythonhosted.org/packages/97/55/f6f1eade1452d4ffd0b3cfff813000097cad15425dd51eb8b2dd1a346386/awscli-1.27.74.tar.gz
...
%prep
%setup -q -n awscli-1.27.74
cd %{_builddir}/awscli-1.27.74
%patch1 -p1
pushd ..
cp -a awscli-1.27.74 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676666756
