...
Source0  : https://files.pythonhosted.org/packages/4e/ba/a22442878c022ae84ccfbb723d9f3b34906fce4fe444eb54ba7c750b9e6f/awscli-1.22.40.tar.gz
...
%prep
%setup -q -n awscli-1.22.40
cd %{_builddir}/awscli-1.22.40
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642712829
...
cp %{_builddir}/awscli-1.22.40/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
