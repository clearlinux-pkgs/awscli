...
Version  : 1.27.36
Release  : 1248
URL      : https://files.pythonhosted.org/packages/5c/bb/5e546098d7c761d48dc7fb791a768baae92e400b850429e53e5bb11aa198/awscli-1.27.36.tar.gz
Source0  : https://files.pythonhosted.org/packages/5c/bb/5e546098d7c761d48dc7fb791a768baae92e400b850429e53e5bb11aa198/awscli-1.27.36.tar.gz
...
%prep
%setup -q -n awscli-1.27.36
cd %{_builddir}/awscli-1.27.36
%patch1 -p1
pushd ..
cp -a awscli-1.27.36 buildavx2
cp -a awscli-1.27.36 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671742505
