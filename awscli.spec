...
Version  : 1.27.88
Release  : 1300
URL      : https://files.pythonhosted.org/packages/7b/af/c353882a1cd92aa813d41ca596b2506777ac227acb4c8d4bde9f866796e3/awscli-1.27.88.tar.gz
Source0  : https://files.pythonhosted.org/packages/7b/af/c353882a1cd92aa813d41ca596b2506777ac227acb4c8d4bde9f866796e3/awscli-1.27.88.tar.gz
...
%prep
%setup -q -n awscli-1.27.88
cd %{_builddir}/awscli-1.27.88
%patch1 -p1
pushd ..
cp -a awscli-1.27.88 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678394643
