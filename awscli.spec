...
Version  : 1.27.28
Release  : 1240
URL      : https://files.pythonhosted.org/packages/10/2a/81e217aa43f63f3b7f26d25da3d90b3035f556303dafaba56631a5413d8b/awscli-1.27.28.tar.gz
Source0  : https://files.pythonhosted.org/packages/10/2a/81e217aa43f63f3b7f26d25da3d90b3035f556303dafaba56631a5413d8b/awscli-1.27.28.tar.gz
...
%prep
%setup -q -n awscli-1.27.28
cd %{_builddir}/awscli-1.27.28
%patch1 -p1
pushd ..
cp -a awscli-1.27.28 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670880158
