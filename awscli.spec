...
Version  : 1.27.34
Release  : 1246
URL      : https://files.pythonhosted.org/packages/64/3f/4cc12bc5961b973a052314d7f50f097918f1d7418661b555cee29f60b5be/awscli-1.27.34.tar.gz
Source0  : https://files.pythonhosted.org/packages/64/3f/4cc12bc5961b973a052314d7f50f097918f1d7418661b555cee29f60b5be/awscli-1.27.34.tar.gz
...
%prep
%setup -q -n awscli-1.27.34
cd %{_builddir}/awscli-1.27.34
%patch1 -p1
pushd ..
cp -a awscli-1.27.34 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671569328
