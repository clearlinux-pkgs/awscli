...
Version  : 1.27.78
Release  : 1290
URL      : https://files.pythonhosted.org/packages/19/8a/678cdbaf11baacbd9b30a200ca0431d5f2f986d0777231acce43c975f086/awscli-1.27.78.tar.gz
Source0  : https://files.pythonhosted.org/packages/19/8a/678cdbaf11baacbd9b30a200ca0431d5f2f986d0777231acce43c975f086/awscli-1.27.78.tar.gz
...
%prep
%setup -q -n awscli-1.27.78
cd %{_builddir}/awscli-1.27.78
%patch1 -p1
pushd ..
cp -a awscli-1.27.78 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677186890
