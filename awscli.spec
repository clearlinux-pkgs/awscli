...
Source0  : https://files.pythonhosted.org/packages/65/8b/7082ac9078f0da4e46fa4c3a74f86b1bc7685358486eb8762e57cc365add/awscli-1.25.73.tar.gz
...
%prep
%setup -q -n awscli-1.25.73
cd %{_builddir}/awscli-1.25.73
%patch1 -p1
pushd ..
cp -a awscli-1.25.73 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663098698
