...
Source0  : https://files.pythonhosted.org/packages/40/d9/6c1b5f6495b8ec6e520a3739006d549cd676c91a90c4415f5b9610168d77/awscli-1.17.13.tar.gz
...
%prep
%setup -q -n awscli-1.17.13
cd %{_builddir}/awscli-1.17.13
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581184821
...
cp %{_builddir}/awscli-1.17.13/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
