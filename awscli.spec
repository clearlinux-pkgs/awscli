...
Source0  : https://files.pythonhosted.org/packages/40/43/732552d577ebd4395ebbd6619d5a641bda0eaece1748064d4595f2cca020/awscli-1.22.60.tar.gz
...
%prep
%setup -q -n awscli-1.22.60
cd %{_builddir}/awscli-1.22.60
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645563586
...
cp %{_builddir}/awscli-1.22.60/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
