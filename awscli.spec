...
Source0  : https://files.pythonhosted.org/packages/1e/44/372fd82a5dd5800f3dc53d04bcc95e0702fad4039c3b7fa2fa8ee18b902d/awscli-1.22.58.tar.gz
...
%prep
%setup -q -n awscli-1.22.58
cd %{_builddir}/awscli-1.22.58
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645218694
...
cp %{_builddir}/awscli-1.22.58/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
