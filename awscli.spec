...
Version  : 1.25.22
Release  : 1123
URL      : https://files.pythonhosted.org/packages/46/c8/0b65222ea3903bbc679f61fe8bc71fb5e670e891080e776d24b82c2dc4cd/awscli-1.25.22.tar.gz
Source0  : https://files.pythonhosted.org/packages/46/c8/0b65222ea3903bbc679f61fe8bc71fb5e670e891080e776d24b82c2dc4cd/awscli-1.25.22.tar.gz
...
%prep
%setup -q -n awscli-1.25.22
cd %{_builddir}/awscli-1.25.22
%patch1 -p1
pushd ..
cp -a awscli-1.25.22 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656704731
...
cp %{_builddir}/awscli-1.25.22/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
