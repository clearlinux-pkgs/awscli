...
Source0  : https://files.pythonhosted.org/packages/93/e2/636f912d88e4bf5a7129c9a4d13c347e4ecd665fe493f680363f5cec0267/awscli-1.36.30.tar.gz
...
%prep
%setup -q -n awscli-1.36.30
cd %{_builddir}/awscli-1.36.30
pushd ..
cp -a awscli-1.36.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735334017
