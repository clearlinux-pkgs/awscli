...
Version  : 1.25.38
Release  : 1140
URL      : https://files.pythonhosted.org/packages/57/9b/4189663dc61a452a8707e6229cdad89f97817d74ccff49be27b5aa63715c/awscli-1.25.38.tar.gz
Source0  : https://files.pythonhosted.org/packages/57/9b/4189663dc61a452a8707e6229cdad89f97817d74ccff49be27b5aa63715c/awscli-1.25.38.tar.gz
...
%prep
%setup -q -n awscli-1.25.38
cd %{_builddir}/awscli-1.25.38
%patch1 -p1
pushd ..
cp -a awscli-1.25.38 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658864849
