...
Version  : 1.21.5
Release  : 954
URL      : https://files.pythonhosted.org/packages/91/e0/9fbca74789d0d0fbe02b386bad51ad05003317be5ec95f420fb80ded64fb/awscli-1.21.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/91/e0/9fbca74789d0d0fbe02b386bad51ad05003317be5ec95f420fb80ded64fb/awscli-1.21.5.tar.gz
...
%prep
%setup -q -n awscli-1.21.5
cd %{_builddir}/awscli-1.21.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635364137
...
cp %{_builddir}/awscli-1.21.5/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
