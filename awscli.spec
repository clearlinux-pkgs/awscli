...
Source0  : https://files.pythonhosted.org/packages/96/30/f584fbc74e4715053ddf542e648059aa6e83921b7d8a35d4e274a66b1493/awscli-1.23.5.tar.gz
...
%prep
%setup -q -n awscli-1.23.5
cd %{_builddir}/awscli-1.23.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651533670
...
cp %{_builddir}/awscli-1.23.5/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
