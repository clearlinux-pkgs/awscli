...
Source0  : https://files.pythonhosted.org/packages/84/e7/b87290ffb5d16c7ed1b302bc4a9e2e0896a01e0ff16423cc5535213f9ed7/awscli-1.27.70.tar.gz
...
%prep
%setup -q -n awscli-1.27.70
cd %{_builddir}/awscli-1.27.70
%patch1 -p1
pushd ..
cp -a awscli-1.27.70 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676320708
