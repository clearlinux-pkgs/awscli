...
Version  : 1.22.78
Release  : 1051
URL      : https://files.pythonhosted.org/packages/50/24/5dfccebe961e7dff5879de3f175ba2e80ce9e23a27f65f78b93c868dc00c/awscli-1.22.78.tar.gz
Source0  : https://files.pythonhosted.org/packages/50/24/5dfccebe961e7dff5879de3f175ba2e80ce9e23a27f65f78b93c868dc00c/awscli-1.22.78.tar.gz
...
%prep
%setup -q -n awscli-1.22.78
cd %{_builddir}/awscli-1.22.78
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647894336
...
cp %{_builddir}/awscli-1.22.78/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
