...
Version  : 1.25.43
Release  : 1145
URL      : https://files.pythonhosted.org/packages/9c/df/ce0eb2fbb5a0de6b1ecd28d3de92111a8ee831d1ca32956856101391729d/awscli-1.25.43.tar.gz
Source0  : https://files.pythonhosted.org/packages/9c/df/ce0eb2fbb5a0de6b1ecd28d3de92111a8ee831d1ca32956856101391729d/awscli-1.25.43.tar.gz
...
%prep
%setup -q -n awscli-1.25.43
cd %{_builddir}/awscli-1.25.43
%patch1 -p1
pushd ..
cp -a awscli-1.25.43 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659382829
