...
Source0  : https://files.pythonhosted.org/packages/8d/49/278de10b22bba018b0ab657fcc28862a38543f8abd3e215018db6b742326/awscli-1.18.157.tar.gz
...
%prep
%setup -q -n awscli-1.18.157
cd %{_builddir}/awscli-1.18.157
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602518369
...
cp %{_builddir}/awscli-1.18.157/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
