...
Version  : 1.25.2
Release  : 1103
URL      : https://files.pythonhosted.org/packages/27/a0/65f9cdbb23f63339f39433e1c1a7d5ac4111e701e2ed0753f181051522d2/awscli-1.25.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/27/a0/65f9cdbb23f63339f39433e1c1a7d5ac4111e701e2ed0753f181051522d2/awscli-1.25.2.tar.gz
...
%prep
%setup -q -n awscli-1.25.2
cd %{_builddir}/awscli-1.25.2
%patch1 -p1
pushd ..
cp -a awscli-1.25.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654198439
...
cp %{_builddir}/awscli-1.25.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
