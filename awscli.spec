...
Version  : 1.31.6
Release  : 1482
URL      : https://files.pythonhosted.org/packages/3c/ef/2740594c4a6a67564023978e52be1ed0f32f4a1df7cd2e133c94ce4df43c/awscli-1.31.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/3c/ef/2740594c4a6a67564023978e52be1ed0f32f4a1df7cd2e133c94ce4df43c/awscli-1.31.6.tar.gz
...
%prep
%setup -q -n awscli-1.31.6
cd %{_builddir}/awscli-1.31.6
pushd ..
cp -a awscli-1.31.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701463447
