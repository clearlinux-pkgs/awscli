...
Source0  : https://files.pythonhosted.org/packages/11/39/40ee46b103ca3b143cb11bbb1c6cb77436b5053c16e99cd985f32705de9d/awscli-1.27.8.tar.gz
...
%prep
%setup -q -n awscli-1.27.8
cd %{_builddir}/awscli-1.27.8
%patch1 -p1
pushd ..
cp -a awscli-1.27.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668210808
