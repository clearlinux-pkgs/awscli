...
Version  : 1.22.72
Release  : 1045
URL      : https://files.pythonhosted.org/packages/44/86/d7285a2d6bf0184b6c15e5a62ccd178e9b58d80f72d9e51ca998d4d53c41/awscli-1.22.72.tar.gz
Source0  : https://files.pythonhosted.org/packages/44/86/d7285a2d6bf0184b6c15e5a62ccd178e9b58d80f72d9e51ca998d4d53c41/awscli-1.22.72.tar.gz
...
%prep
%setup -q -n awscli-1.22.72
cd %{_builddir}/awscli-1.22.72
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646945951
...
cp %{_builddir}/awscli-1.22.72/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
