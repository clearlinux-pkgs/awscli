...
Version  : 1.24.8
Release  : 1098
URL      : https://files.pythonhosted.org/packages/5c/a0/b892b1a1219b49e3744de81ccbfc45db132b99b23bee83c4478343c1bffb/awscli-1.24.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/5c/a0/b892b1a1219b49e3744de81ccbfc45db132b99b23bee83c4478343c1bffb/awscli-1.24.8.tar.gz
...
%prep
%setup -q -n awscli-1.24.8
cd %{_builddir}/awscli-1.24.8
%patch1 -p1
pushd ..
cp -a awscli-1.24.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653508024
...
cp %{_builddir}/awscli-1.24.8/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
