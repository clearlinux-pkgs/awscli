...
Version  : 1.27.48
Release  : 1260
URL      : https://files.pythonhosted.org/packages/dc/12/158b58836b6cd4ee5fcf382e897c73e2af9644f982be8dfb50dffc1bb967/awscli-1.27.48.tar.gz
Source0  : https://files.pythonhosted.org/packages/dc/12/158b58836b6cd4ee5fcf382e897c73e2af9644f982be8dfb50dffc1bb967/awscli-1.27.48.tar.gz
...
%prep
%setup -q -n awscli-1.27.48
cd %{_builddir}/awscli-1.27.48
%patch1 -p1
pushd ..
cp -a awscli-1.27.48 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673470082
