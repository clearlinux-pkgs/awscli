...
Version  : 1.25.1
Release  : 1102
URL      : https://files.pythonhosted.org/packages/b8/d9/e7a0771a5db9d187cdd7997c778ad420abc00e5e073bb8509acde7e2995b/awscli-1.25.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/b8/d9/e7a0771a5db9d187cdd7997c778ad420abc00e5e073bb8509acde7e2995b/awscli-1.25.1.tar.gz
...
%prep
%setup -q -n awscli-1.25.1
cd %{_builddir}/awscli-1.25.1
%patch1 -p1
pushd ..
cp -a awscli-1.25.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654116167
...
cp %{_builddir}/awscli-1.25.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
