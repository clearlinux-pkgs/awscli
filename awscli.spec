...
Source0  : https://files.pythonhosted.org/packages/cc/1b/e5b30dcfc94d3c6216713f4780b186d019476f50ddf9128f3d6180773cd8/awscli-1.22.90.tar.gz
...
%prep
%setup -q -n awscli-1.22.90
cd %{_builddir}/awscli-1.22.90
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649275210
...
cp %{_builddir}/awscli-1.22.90/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
