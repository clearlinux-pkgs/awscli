...
Source0  : https://files.pythonhosted.org/packages/93/ae/4bf41bd2d9e5cbecd7a75128604c40d0f7839d13c580909f1a18d4a0ff82/awscli-1.25.10.tar.gz
...
%prep
%setup -q -n awscli-1.25.10
cd %{_builddir}/awscli-1.25.10
%patch1 -p1
pushd ..
cp -a awscli-1.25.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655333130
...
cp %{_builddir}/awscli-1.25.10/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
