...
Source0  : https://files.pythonhosted.org/packages/e1/04/b3281ebad507cd1fbfc5a3053f95aaf33104c08f01ce02c152dbd26b85ed/awscli-1.22.26.tar.gz
...
%prep
%setup -q -n awscli-1.22.26
cd %{_builddir}/awscli-1.22.26
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640119667
...
cp %{_builddir}/awscli-1.22.26/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
