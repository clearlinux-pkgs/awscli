...
Source0  : https://files.pythonhosted.org/packages/88/30/340f473dbdc4ce5e347eb5c5c5c4864cc7a9b14cfa69bafbaebf3917f6cd/awscli-1.27.138.tar.gz
...
%prep
%setup -q -n awscli-1.27.138
cd %{_builddir}/awscli-1.27.138
%patch1 -p1
pushd ..
cp -a awscli-1.27.138 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684784121
