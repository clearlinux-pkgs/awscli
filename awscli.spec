...
Version  : 1.27.6
Release  : 1217
URL      : https://files.pythonhosted.org/packages/b2/34/268af0b3cd15a723737739aaefc320866bfdec7b9a06b5b3c8b2ba628338/awscli-1.27.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/b2/34/268af0b3cd15a723737739aaefc320866bfdec7b9a06b5b3c8b2ba628338/awscli-1.27.6.tar.gz
...
%prep
%setup -q -n awscli-1.27.6
cd %{_builddir}/awscli-1.27.6
%patch1 -p1
pushd ..
cp -a awscli-1.27.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668034740
