...
Version  : 1.25.8
Release  : 1109
URL      : https://files.pythonhosted.org/packages/b0/9c/10be8590fea99f7500bf1b89f806784d0751841409b6120b1d9182dd42ee/awscli-1.25.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/b0/9c/10be8590fea99f7500bf1b89f806784d0751841409b6120b1d9182dd42ee/awscli-1.25.8.tar.gz
...
%prep
%setup -q -n awscli-1.25.8
cd %{_builddir}/awscli-1.25.8
%patch1 -p1
pushd ..
cp -a awscli-1.25.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655160375
...
cp %{_builddir}/awscli-1.25.8/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
