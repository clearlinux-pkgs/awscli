...
Version  : 1.23.2
Release  : 1077
URL      : https://files.pythonhosted.org/packages/a9/72/6ae3a652432377eef96e107214e033cc0136ddd623444cf2cd6afffaf80d/awscli-1.23.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/a9/72/6ae3a652432377eef96e107214e033cc0136ddd623444cf2cd6afffaf80d/awscli-1.23.2.tar.gz
...
%prep
%setup -q -n awscli-1.23.2
cd %{_builddir}/awscli-1.23.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651089269
...
cp %{_builddir}/awscli-1.23.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
