...
Version  : 1.25.82
Release  : 1187
URL      : https://files.pythonhosted.org/packages/f2/3c/0afb03726b16670a78c5384a21db461c75af98b83ca830bb1102211bdd29/awscli-1.25.82.tar.gz
Source0  : https://files.pythonhosted.org/packages/f2/3c/0afb03726b16670a78c5384a21db461c75af98b83ca830bb1102211bdd29/awscli-1.25.82.tar.gz
...
%prep
%setup -q -n awscli-1.25.82
cd %{_builddir}/awscli-1.25.82
%patch1 -p1
pushd ..
cp -a awscli-1.25.82 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664221434
