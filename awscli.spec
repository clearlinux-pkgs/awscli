...
Version  : 1.17.7
Release  : 547
URL      : https://files.pythonhosted.org/packages/b1/fd/3df55c24e14fed6cb9f65248f0fe98c44a9f294cd7b53a39768e803eff58/awscli-1.17.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/b1/fd/3df55c24e14fed6cb9f65248f0fe98c44a9f294cd7b53a39768e803eff58/awscli-1.17.7.tar.gz
...
%prep
%setup -q -n awscli-1.17.7
cd %{_builddir}/awscli-1.17.7
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579653925
...
cp %{_builddir}/awscli-1.17.7/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/e42b85dcbe49e5aa66fe2117f92a60f4c39666d5
