...
Source0  : https://files.pythonhosted.org/packages/78/c2/5addcc8e66ac3491aa97006530f8a63cf44f70be5bcf30cf6dd9ceb31f50/awscli-1.25.60.tar.gz
...
%prep
%setup -q -n awscli-1.25.60
cd %{_builddir}/awscli-1.25.60
%patch1 -p1
pushd ..
cp -a awscli-1.25.60 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661380987
