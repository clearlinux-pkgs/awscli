...
Version  : 1.18.77
Release  : 636
URL      : https://files.pythonhosted.org/packages/a7/58/4e934904c027cf6a3736d0ef0808eb40eb9a88d525fa9bb54d6a551f3ae3/awscli-1.18.77.tar.gz
Source0  : https://files.pythonhosted.org/packages/a7/58/4e934904c027cf6a3736d0ef0808eb40eb9a88d525fa9bb54d6a551f3ae3/awscli-1.18.77.tar.gz
...
%prep
%setup -q -n awscli-1.18.77
cd %{_builddir}/awscli-1.18.77
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591829018
...
cp %{_builddir}/awscli-1.18.77/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
