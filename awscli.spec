...
Version  : 1.18.3
Release  : 560
URL      : https://files.pythonhosted.org/packages/99/d9/d0ed76e4205ed9f06acfb51d41200997121ac3e85eb8044c244ae46153e8/awscli-1.18.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/99/d9/d0ed76e4205ed9f06acfb51d41200997121ac3e85eb8044c244ae46153e8/awscli-1.18.3.tar.gz
...
%prep
%setup -q -n awscli-1.18.3
cd %{_builddir}/awscli-1.18.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582160951
...
cp %{_builddir}/awscli-1.18.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
