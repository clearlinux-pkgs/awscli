...
Source0  : https://files.pythonhosted.org/packages/6a/d4/6921837b93a514e471c645a52fec9fe8960700bdb71ea987d81a7bb201e3/awscli-1.22.50.tar.gz
...
%prep
%setup -q -n awscli-1.22.50
cd %{_builddir}/awscli-1.22.50
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644267625
...
cp %{_builddir}/awscli-1.22.50/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
