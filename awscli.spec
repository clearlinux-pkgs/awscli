...
Version  : 1.27.24
Release  : 1236
URL      : https://files.pythonhosted.org/packages/de/cf/64356f7dd0e8cdee7921420574e533a58bc0334ffb2754272840e3a00983/awscli-1.27.24.tar.gz
Source0  : https://files.pythonhosted.org/packages/de/cf/64356f7dd0e8cdee7921420574e533a58bc0334ffb2754272840e3a00983/awscli-1.27.24.tar.gz
...
%prep
%setup -q -n awscli-1.27.24
cd %{_builddir}/awscli-1.27.24
%patch1 -p1
pushd ..
cp -a awscli-1.27.24 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670359235
