...
Version  : 1.22.17
Release  : 987
URL      : https://files.pythonhosted.org/packages/4d/3c/29833159a0d10cbcf803507d7840a937f5e3d8953f25b75eb540d2345a36/awscli-1.22.17.tar.gz
Source0  : https://files.pythonhosted.org/packages/4d/3c/29833159a0d10cbcf803507d7840a937f5e3d8953f25b75eb540d2345a36/awscli-1.22.17.tar.gz
...
%prep
%setup -q -n awscli-1.22.17
cd %{_builddir}/awscli-1.22.17
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638327158
...
cp %{_builddir}/awscli-1.22.17/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
