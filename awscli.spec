...
Version  : 1.19.56
Release  : 830
URL      : https://files.pythonhosted.org/packages/8b/4a/eda464aeb78ed75d7e0a41b57973b8e42ddd8aca225fb9392969484a3df7/awscli-1.19.56.tar.gz
Source0  : https://files.pythonhosted.org/packages/8b/4a/eda464aeb78ed75d7e0a41b57973b8e42ddd8aca225fb9392969484a3df7/awscli-1.19.56.tar.gz
...
%prep
%setup -q -n awscli-1.19.56
cd %{_builddir}/awscli-1.19.56
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619142116
...
cp %{_builddir}/awscli-1.19.56/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
