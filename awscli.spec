...
Version  : 1.22.91
Release  : 1064
URL      : https://files.pythonhosted.org/packages/a6/46/d47bd69561d8a1e633711aababf1b23eaea321384561ec66cd28146adc76/awscli-1.22.91.tar.gz
Source0  : https://files.pythonhosted.org/packages/a6/46/d47bd69561d8a1e633711aababf1b23eaea321384561ec66cd28146adc76/awscli-1.22.91.tar.gz
...
%prep
%setup -q -n awscli-1.22.91
cd %{_builddir}/awscli-1.22.91
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649369055
...
cp %{_builddir}/awscli-1.22.91/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
