...
Version  : 1.25.81
Release  : 1186
URL      : https://files.pythonhosted.org/packages/0d/f2/02835d2df5a386f95297a5507e856b72cfac49f64ba1f55af161a0a3c158/awscli-1.25.81.tar.gz
Source0  : https://files.pythonhosted.org/packages/0d/f2/02835d2df5a386f95297a5507e856b72cfac49f64ba1f55af161a0a3c158/awscli-1.25.81.tar.gz
...
%prep
%setup -q -n awscli-1.25.81
cd %{_builddir}/awscli-1.25.81
%patch1 -p1
pushd ..
cp -a awscli-1.25.81 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663962809
