...
Version  : 1.25.18
Release  : 1119
URL      : https://files.pythonhosted.org/packages/3e/bf/bb76434d0eb230340e44bf478c6e058f7d2b7ab325575f4616e9d0cd78c5/awscli-1.25.18.tar.gz
Source0  : https://files.pythonhosted.org/packages/3e/bf/bb76434d0eb230340e44bf478c6e058f7d2b7ab325575f4616e9d0cd78c5/awscli-1.25.18.tar.gz
...
%prep
%setup -q -n awscli-1.25.18
cd %{_builddir}/awscli-1.25.18
%patch1 -p1
pushd ..
cp -a awscli-1.25.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656359791
...
cp %{_builddir}/awscli-1.25.18/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
