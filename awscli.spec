...
Version  : 1.18.6
Release  : 563
URL      : https://files.pythonhosted.org/packages/40/4c/10e86b9595a1e1320986c014d62f584625c7f429cfaff02906368dc75926/awscli-1.18.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/40/4c/10e86b9595a1e1320986c014d62f584625c7f429cfaff02906368dc75926/awscli-1.18.6.tar.gz
...
%prep
%setup -q -n awscli-1.18.6
cd %{_builddir}/awscli-1.18.6
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582639995
...
cp %{_builddir}/awscli-1.18.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
