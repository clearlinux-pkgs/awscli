...
Version  : 1.20.55
Release  : 936
URL      : https://files.pythonhosted.org/packages/1c/88/36d41cc48ecda821bd2a6c1c7cbe77f3432819fa85359232b78a1586b03d/awscli-1.20.55.tar.gz
Source0  : https://files.pythonhosted.org/packages/1c/88/36d41cc48ecda821bd2a6c1c7cbe77f3432819fa85359232b78a1586b03d/awscli-1.20.55.tar.gz
...
%prep
%setup -q -n awscli-1.20.55
cd %{_builddir}/awscli-1.20.55
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633529281
...
cp %{_builddir}/awscli-1.20.55/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
