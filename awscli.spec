...
Source0  : https://files.pythonhosted.org/packages/21/5a/5f9ff673a205130ade8125a165f56be99458bb934341822297682f18be8d/awscli-1.34.24.tar.gz
...
%prep
%setup -q -n awscli-1.34.24
cd %{_builddir}/awscli-1.34.24
pushd ..
cp -a awscli-1.34.24 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726862422
