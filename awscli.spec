...
Version  : 1.31.5
Release  : 1481
URL      : https://files.pythonhosted.org/packages/42/28/8cf3e71fbd2a9cf2ab81618e217350d07adea88fc2d9b121615a9dfc9747/awscli-1.31.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/42/28/8cf3e71fbd2a9cf2ab81618e217350d07adea88fc2d9b121615a9dfc9747/awscli-1.31.5.tar.gz
...
%prep
%setup -q -n awscli-1.31.5
cd %{_builddir}/awscli-1.31.5
pushd ..
cp -a awscli-1.31.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701387643
