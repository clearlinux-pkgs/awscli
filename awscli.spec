...
Source0  : https://files.pythonhosted.org/packages/74/30/796aceddb015018f32ec164b5fa5d15c04b69d96f3573fd0e8c1241c44ed/awscli-1.27.10.tar.gz
...
%prep
%setup -q -n awscli-1.27.10
cd %{_builddir}/awscli-1.27.10
%patch1 -p1
pushd ..
cp -a awscli-1.27.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668545615
