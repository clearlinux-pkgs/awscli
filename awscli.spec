...
Version  : 1.27.38
Release  : 1250
URL      : https://files.pythonhosted.org/packages/a2/93/fdaaa23dbd90349ab2e41c267f051af2f471c7f616fbcf55e130b550f006/awscli-1.27.38.tar.gz
Source0  : https://files.pythonhosted.org/packages/a2/93/fdaaa23dbd90349ab2e41c267f051af2f471c7f616fbcf55e130b550f006/awscli-1.27.38.tar.gz
...
%prep
%setup -q -n awscli-1.27.38
cd %{_builddir}/awscli-1.27.38
%patch1 -p1
pushd ..
cp -a awscli-1.27.38 buildavx2
cp -a awscli-1.27.38 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672174527
