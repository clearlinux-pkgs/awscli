...
Version  : 1.18.5
Release  : 562
URL      : https://files.pythonhosted.org/packages/bd/3f/beeb6b65affc744ae81db784a50a5e5a982e99e8dabf010250086a305d18/awscli-1.18.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/bd/3f/beeb6b65affc744ae81db784a50a5e5a982e99e8dabf010250086a305d18/awscli-1.18.5.tar.gz
...
%prep
%setup -q -n awscli-1.18.5
cd %{_builddir}/awscli-1.18.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582322875
...
cp %{_builddir}/awscli-1.18.5/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
