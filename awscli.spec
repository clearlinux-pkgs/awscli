...
Source0  : https://files.pythonhosted.org/packages/bc/f7/b6c4605e9748c973c241833664e937c23749d377c76c54eb04cc5c241709/awscli-1.24.0.tar.gz
...
%prep
%setup -q -n awscli-1.24.0
cd %{_builddir}/awscli-1.24.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652470911
...
cp %{_builddir}/awscli-1.24.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
