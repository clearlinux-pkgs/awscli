...
Source0  : https://files.pythonhosted.org/packages/52/3c/99f070a6be4f605501763ad5afe8b74d6cbf1cb66106307273c425815586/awscli-1.24.10.tar.gz
...
%prep
%setup -q -n awscli-1.24.10
cd %{_builddir}/awscli-1.24.10
%patch1 -p1
pushd ..
cp -a awscli-1.24.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653680769
...
cp %{_builddir}/awscli-1.24.10/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
