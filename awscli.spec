...
Version  : 1.20.49
Release  : 930
URL      : https://files.pythonhosted.org/packages/74/9e/702dab014aef29fb4d13eb9388f32c90d5cd604967898bbc25f8dc468b20/awscli-1.20.49.tar.gz
Source0  : https://files.pythonhosted.org/packages/74/9e/702dab014aef29fb4d13eb9388f32c90d5cd604967898bbc25f8dc468b20/awscli-1.20.49.tar.gz
...
%prep
%setup -q -n awscli-1.20.49
cd %{_builddir}/awscli-1.20.49
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632784834
...
cp %{_builddir}/awscli-1.20.49/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
