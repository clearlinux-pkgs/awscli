...
Version  : 1.27.64
Release  : 1276
URL      : https://files.pythonhosted.org/packages/dd/bd/f67d9fbf512f810de318d2c10272d5eebb6c3821bc0f4b96577e93046d79/awscli-1.27.64.tar.gz
Source0  : https://files.pythonhosted.org/packages/dd/bd/f67d9fbf512f810de318d2c10272d5eebb6c3821bc0f4b96577e93046d79/awscli-1.27.64.tar.gz
...
%prep
%setup -q -n awscli-1.27.64
cd %{_builddir}/awscli-1.27.64
%patch1 -p1
pushd ..
cp -a awscli-1.27.64 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675467709
