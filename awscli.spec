...
Version  : 1.36.5
Release  : 1718
URL      : https://files.pythonhosted.org/packages/a1/97/662504e805957115cc9f6c1994fd0c25315513f092453fe9cde0240a9d2d/awscli-1.36.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/a1/97/662504e805957115cc9f6c1994fd0c25315513f092453fe9cde0240a9d2d/awscli-1.36.5.tar.gz
...
%prep
%setup -q -n awscli-1.36.5
cd %{_builddir}/awscli-1.36.5
pushd ..
cp -a awscli-1.36.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731963276
