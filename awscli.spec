...
Source0  : https://files.pythonhosted.org/packages/b8/e2/af43a0ffaee068ebfa64fd835c2bb8a5412ea51f9874497140f7267cd13b/awscli-1.21.10.tar.gz
...
%prep
%setup -q -n awscli-1.21.10
cd %{_builddir}/awscli-1.21.10
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635969120
...
cp %{_builddir}/awscli-1.21.10/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
