...
Version  : 1.27.15
Release  : 1227
URL      : https://files.pythonhosted.org/packages/ba/c7/9fc78908cf0338bb95bd5e8468da4d509ce017c99bb29e7e637563ee5843/awscli-1.27.15.tar.gz
Source0  : https://files.pythonhosted.org/packages/ba/c7/9fc78908cf0338bb95bd5e8468da4d509ce017c99bb29e7e637563ee5843/awscli-1.27.15.tar.gz
...
%prep
%setup -q -n awscli-1.27.15
cd %{_builddir}/awscli-1.27.15
%patch1 -p1
pushd ..
cp -a awscli-1.27.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669149863
