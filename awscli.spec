...
%prep
%setup -q -n awscli-1.22.47
cd %{_builddir}/awscli-1.22.47
%patch1 -p1
...
cp %{_builddir}/awscli-1.22.47/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
