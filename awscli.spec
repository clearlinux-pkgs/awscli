...
Source0  : https://files.pythonhosted.org/packages/89/aa/e956f87de14ba6c7599b2bf8a7cb62b1a206ad8d3ae90d6411550b439ff7/awscli-1.22.70.tar.gz
...
%prep
%setup -q -n awscli-1.22.70
cd %{_builddir}/awscli-1.22.70
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646773402
...
cp %{_builddir}/awscli-1.22.70/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
