...
Source0  : https://files.pythonhosted.org/packages/d6/f4/100d38b2b277682b2d155e15f8fb7acfad658efe72367965616efaa39453/awscli-1.27.50.tar.gz
...
%prep
%setup -q -n awscli-1.27.50
cd %{_builddir}/awscli-1.27.50
%patch1 -p1
pushd ..
cp -a awscli-1.27.50 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673643181
