...
Version  : 1.18.4
Release  : 561
URL      : https://files.pythonhosted.org/packages/b3/0e/23449c8cd0d310acc7a0b1607ecc9b3486270a2e9ef3ef75c6608f9a2fa4/awscli-1.18.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/b3/0e/23449c8cd0d310acc7a0b1607ecc9b3486270a2e9ef3ef75c6608f9a2fa4/awscli-1.18.4.tar.gz
...
%prep
%setup -q -n awscli-1.18.4
cd %{_builddir}/awscli-1.18.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582300028
...
cp %{_builddir}/awscli-1.18.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
