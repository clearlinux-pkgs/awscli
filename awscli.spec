...
Version  : 1.20.5
Release  : 893
URL      : https://files.pythonhosted.org/packages/92/64/dcf61268bcc98f828bccfcdfb227a98e2b51fcc2201226160860743ea5e8/awscli-1.20.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/92/64/dcf61268bcc98f828bccfcdfb227a98e2b51fcc2201226160860743ea5e8/awscli-1.20.5.tar.gz
...
%prep
%setup -q -n awscli-1.20.5
cd %{_builddir}/awscli-1.20.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627048847
...
cp %{_builddir}/awscli-1.20.5/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
