...
Version  : 1.25.78
Release  : 1183
URL      : https://files.pythonhosted.org/packages/b3/4b/a9a627a0f5b41da34ef512cb9018a8d515817e5649b56a9e8e2b84c57dce/awscli-1.25.78.tar.gz
Source0  : https://files.pythonhosted.org/packages/b3/4b/a9a627a0f5b41da34ef512cb9018a8d515817e5649b56a9e8e2b84c57dce/awscli-1.25.78.tar.gz
...
%prep
%setup -q -n awscli-1.25.78
cd %{_builddir}/awscli-1.25.78
%patch1 -p1
pushd ..
cp -a awscli-1.25.78 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663713746
