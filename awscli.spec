...
Version  : 1.25.34
Release  : 1135
URL      : https://files.pythonhosted.org/packages/d6/7f/a73d11a85cc38c2f4dee3ffca64b3afec356e4533d53f3a83eda707213ce/awscli-1.25.34.tar.gz
Source0  : https://files.pythonhosted.org/packages/d6/7f/a73d11a85cc38c2f4dee3ffca64b3afec356e4533d53f3a83eda707213ce/awscli-1.25.34.tar.gz
...
%prep
%setup -q -n awscli-1.25.34
cd %{_builddir}/awscli-1.25.34
%patch1 -p1
pushd ..
cp -a awscli-1.25.34 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658346031
...
cp %{_builddir}/awscli-1.25.34/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
