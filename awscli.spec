...
Version  : 1.20.63
Release  : 944
URL      : https://files.pythonhosted.org/packages/6b/01/910aba683eff1ec5ceee266c64333ad430fb30c06230731f238c371da0bd/awscli-1.20.63.tar.gz
Source0  : https://files.pythonhosted.org/packages/6b/01/910aba683eff1ec5ceee266c64333ad430fb30c06230731f238c371da0bd/awscli-1.20.63.tar.gz
...
%prep
%setup -q -n awscli-1.20.63
cd %{_builddir}/awscli-1.20.63
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634577826
...
cp %{_builddir}/awscli-1.20.63/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
