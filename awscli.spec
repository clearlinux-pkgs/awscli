...
Version  : 1.27.25
Release  : 1237
URL      : https://files.pythonhosted.org/packages/9e/b2/110b966a77ace48eb3470bc6d852587bfad53d675e04a0802c0cde75c36b/awscli-1.27.25.tar.gz
Source0  : https://files.pythonhosted.org/packages/9e/b2/110b966a77ace48eb3470bc6d852587bfad53d675e04a0802c0cde75c36b/awscli-1.27.25.tar.gz
...
%prep
%setup -q -n awscli-1.27.25
cd %{_builddir}/awscli-1.27.25
%patch1 -p1
pushd ..
cp -a awscli-1.27.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670456771
