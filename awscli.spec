...
Source0  : https://files.pythonhosted.org/packages/eb/d2/b742c43c1393bd3e04ef3bb7bb575c5225876140521a072fb6542657ab2e/awscli-1.25.72.tar.gz
...
%prep
%setup -q -n awscli-1.25.72
cd %{_builddir}/awscli-1.25.72
%patch1 -p1
pushd ..
cp -a awscli-1.25.72 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663012422
