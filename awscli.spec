...
Source0  : https://files.pythonhosted.org/packages/f8/ef/eaa9a806a54b9244c532df70619f845c8085ebb40d77b6e5c23332ee1ea3/awscli-1.22.20.tar.gz
...
%prep
%setup -q -n awscli-1.22.20
cd %{_builddir}/awscli-1.22.20
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638565217
...
cp %{_builddir}/awscli-1.22.20/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
