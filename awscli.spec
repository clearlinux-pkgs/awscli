...
Version  : 1.27.82
Release  : 1294
URL      : https://files.pythonhosted.org/packages/4a/dc/67296af2e7352115b13fe67868917944b933829886218ca54f061ab9725c/awscli-1.27.82.tar.gz
Source0  : https://files.pythonhosted.org/packages/4a/dc/67296af2e7352115b13fe67868917944b933829886218ca54f061ab9725c/awscli-1.27.82.tar.gz
...
%prep
%setup -q -n awscli-1.27.82
cd %{_builddir}/awscli-1.27.82
%patch1 -p1
pushd ..
cp -a awscli-1.27.82 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677703477
