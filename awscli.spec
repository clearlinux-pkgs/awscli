...
Version  : 1.20.2
Release  : 889
URL      : https://files.pythonhosted.org/packages/f4/dd/5a44b75daac16b5b4c0134fbf42b800b9fdf36ecd2de9f426bb0d261a407/awscli-1.20.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/f4/dd/5a44b75daac16b5b4c0134fbf42b800b9fdf36ecd2de9f426bb0d261a407/awscli-1.20.2.tar.gz
...
%prep
%setup -q -n awscli-1.20.2
cd %{_builddir}/awscli-1.20.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626729354
...
cp %{_builddir}/awscli-1.20.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
