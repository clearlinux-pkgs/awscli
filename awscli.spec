...
Version  : 1.19.34
Release  : 811
URL      : https://files.pythonhosted.org/packages/40/ed/8eb2de9bad131e4bd84e19ee0a25ea7e2d8641f59885e74c9f82adfa77d4/awscli-1.19.34.tar.gz
Source0  : https://files.pythonhosted.org/packages/40/ed/8eb2de9bad131e4bd84e19ee0a25ea7e2d8641f59885e74c9f82adfa77d4/awscli-1.19.34.tar.gz
...
%prep
%setup -q -n awscli-1.19.34
cd %{_builddir}/awscli-1.19.34
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616508389
...
cp %{_builddir}/awscli-1.19.34/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
