...
Version  : 1.24.5
Release  : 1094
URL      : https://files.pythonhosted.org/packages/67/96/e84534d0e65fdf4d32b98b0c421aec5a3139c7a51ea8eb667a4dbcd84d02/awscli-1.24.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/67/96/e84534d0e65fdf4d32b98b0c421aec5a3139c7a51ea8eb667a4dbcd84d02/awscli-1.24.5.tar.gz
...
%prep
%setup -q -n awscli-1.24.5
cd %{_builddir}/awscli-1.24.5
%patch1 -p1
pushd ..
cp -a awscli-1.24.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653331269
...
cp %{_builddir}/awscli-1.24.5/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
