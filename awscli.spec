...
Version  : 1.25.87
Release  : 1192
URL      : https://files.pythonhosted.org/packages/41/21/aa78d0d748e5be1bd5ce31a2c2410aed562a8b062705361c8fbcd04cd9fa/awscli-1.25.87.tar.gz
Source0  : https://files.pythonhosted.org/packages/41/21/aa78d0d748e5be1bd5ce31a2c2410aed562a8b062705361c8fbcd04cd9fa/awscli-1.25.87.tar.gz
...
%prep
%setup -q -n awscli-1.25.87
cd %{_builddir}/awscli-1.25.87
%patch1 -p1
pushd ..
cp -a awscli-1.25.87 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664923938
