...
Version  : 1.22.94
Release  : 1067
URL      : https://files.pythonhosted.org/packages/61/ee/cfe70aabeac068ed7cce176e524c99bddae631db5feea7a060cbb88d6da1/awscli-1.22.94.tar.gz
Source0  : https://files.pythonhosted.org/packages/61/ee/cfe70aabeac068ed7cce176e524c99bddae631db5feea7a060cbb88d6da1/awscli-1.22.94.tar.gz
...
%prep
%setup -q -n awscli-1.22.94
cd %{_builddir}/awscli-1.22.94
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649803799
...
cp %{_builddir}/awscli-1.22.94/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
