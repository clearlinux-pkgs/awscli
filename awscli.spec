...
Version  : 1.25.41
Release  : 1143
URL      : https://files.pythonhosted.org/packages/38/32/94c178cc59d52d26a28549bf0e11dc9b2412eee516c81edc885b35986813/awscli-1.25.41.tar.gz
Source0  : https://files.pythonhosted.org/packages/38/32/94c178cc59d52d26a28549bf0e11dc9b2412eee516c81edc885b35986813/awscli-1.25.41.tar.gz
...
%prep
%setup -q -n awscli-1.25.41
cd %{_builddir}/awscli-1.25.41
%patch1 -p1
pushd ..
cp -a awscli-1.25.41 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659123898
