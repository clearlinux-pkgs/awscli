...
Version  : 1.23.4
Release  : 1079
URL      : https://files.pythonhosted.org/packages/9c/80/7b678d46f4e20594f05f832caf756708a8ceffd5d2546e54be283cb6ef3f/awscli-1.23.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/9c/80/7b678d46f4e20594f05f832caf756708a8ceffd5d2546e54be283cb6ef3f/awscli-1.23.4.tar.gz
...
%prep
%setup -q -n awscli-1.23.4
cd %{_builddir}/awscli-1.23.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651516631
...
cp %{_builddir}/awscli-1.23.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
