...
Source0  : https://files.pythonhosted.org/packages/f1/f9/650b63e957f0fbb9c48dde2dfac078c4532b739e23bad663761e443585a0/awscli-1.25.0.tar.gz
...
%prep
%setup -q -n awscli-1.25.0
cd %{_builddir}/awscli-1.25.0
%patch1 -p1
pushd ..
cp -a awscli-1.25.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654036893
...
cp %{_builddir}/awscli-1.25.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
