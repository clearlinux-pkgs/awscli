...
Source0  : https://files.pythonhosted.org/packages/24/90/d2daeb4a893e92112ce6b0f9c752a0c617a0e601f3088fac56632b5c5312/awscli-1.21.7.tar.gz
...
%prep
%setup -q -n awscli-1.21.7
cd %{_builddir}/awscli-1.21.7
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635538141
...
cp %{_builddir}/awscli-1.21.7/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
