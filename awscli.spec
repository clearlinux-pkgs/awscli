...
Version  : 1.30.5
Release  : 1473
URL      : https://files.pythonhosted.org/packages/3a/2b/601291e200418f41ce2a8ce1c7a5d223172c3ebb6ece01ed65e68b43482e/awscli-1.30.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/3a/2b/601291e200418f41ce2a8ce1c7a5d223172c3ebb6ece01ed65e68b43482e/awscli-1.30.5.tar.gz
...
%prep
%setup -q -n awscli-1.30.5
cd %{_builddir}/awscli-1.30.5
pushd ..
cp -a awscli-1.30.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700600675
