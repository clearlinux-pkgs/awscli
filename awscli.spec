...
Version  : 1.20.22
Release  : 910
URL      : https://files.pythonhosted.org/packages/98/6f/01fb95b9d4081e06c598af0c1950ad5463d7476fa23a76f97ee36844d6ef/awscli-1.20.22.tar.gz
Source0  : https://files.pythonhosted.org/packages/98/6f/01fb95b9d4081e06c598af0c1950ad5463d7476fa23a76f97ee36844d6ef/awscli-1.20.22.tar.gz
...
%prep
%setup -q -n awscli-1.20.22
cd %{_builddir}/awscli-1.20.22
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629156833
...
cp %{_builddir}/awscli-1.20.22/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
