...
Source0  : https://files.pythonhosted.org/packages/87/4c/6b0b4b715ae5d5b6594bce69998d0c01d335ad97fc8c5ccfee4b984695a5/awscli-1.27.67.tar.gz
...
%prep
%setup -q -n awscli-1.27.67
cd %{_builddir}/awscli-1.27.67
%patch1 -p1
pushd ..
cp -a awscli-1.27.67 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675890782
