...
Version  : 1.25.49
Release  : 1150
URL      : https://files.pythonhosted.org/packages/2c/04/abdb9a63a0f95aa01d30c7316131d2af5215218efb0ee8e7f9d5afcce331/awscli-1.25.49.tar.gz
Source0  : https://files.pythonhosted.org/packages/2c/04/abdb9a63a0f95aa01d30c7316131d2af5215218efb0ee8e7f9d5afcce331/awscli-1.25.49.tar.gz
...
%prep
%setup -q -n awscli-1.25.49
cd %{_builddir}/awscli-1.25.49
%patch1 -p1
pushd ..
cp -a awscli-1.25.49 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660160909
