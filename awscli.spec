...
Version  : 1.25.31
Release  : 1132
URL      : https://files.pythonhosted.org/packages/92/41/cc464b6ee527308e5b6e2fbd89b3c263fbde847037158c42283355c99725/awscli-1.25.31.tar.gz
Source0  : https://files.pythonhosted.org/packages/92/41/cc464b6ee527308e5b6e2fbd89b3c263fbde847037158c42283355c99725/awscli-1.25.31.tar.gz
...
%prep
%setup -q -n awscli-1.25.31
cd %{_builddir}/awscli-1.25.31
%patch1 -p1
pushd ..
cp -a awscli-1.25.31 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657914170
...
cp %{_builddir}/awscli-1.25.31/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
