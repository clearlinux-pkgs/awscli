...
Version  : 1.22.4
Release  : 970
URL      : https://files.pythonhosted.org/packages/65/82/d4418cbd64a46b5ddb1f76f5a8a46929367a9fe6b87ae67f2d82617da8a4/awscli-1.22.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/65/82/d4418cbd64a46b5ddb1f76f5a8a46929367a9fe6b87ae67f2d82617da8a4/awscli-1.22.4.tar.gz
...
%prep
%setup -q -n awscli-1.22.4
cd %{_builddir}/awscli-1.22.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636664034
...
cp %{_builddir}/awscli-1.22.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
