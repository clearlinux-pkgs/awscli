...
Version  : 1.32.35
Release  : 1525
URL      : https://files.pythonhosted.org/packages/cb/96/89d5d823db1f563a86dde1e07eeec9f8e7061a3902bc501bf8f04e6ae4a9/awscli-1.32.35.tar.gz
Source0  : https://files.pythonhosted.org/packages/cb/96/89d5d823db1f563a86dde1e07eeec9f8e7061a3902bc501bf8f04e6ae4a9/awscli-1.32.35.tar.gz
...
%prep
%setup -q -n awscli-1.32.35
cd %{_builddir}/awscli-1.32.35
pushd ..
cp -a awscli-1.32.35 buildavx2
popd
pushd ..
cp -a awscli-1.32.35 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707165776
