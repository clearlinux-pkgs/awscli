...
Source0  : https://files.pythonhosted.org/packages/7a/2b/2fbca711a5a5a4d71a37067c9982267f8fb7bb1f1439828b50f03105eb3f/awscli-1.22.0.tar.gz
...
%prep
%setup -q -n awscli-1.22.0
cd %{_builddir}/awscli-1.22.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636404850
...
cp %{_builddir}/awscli-1.22.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
