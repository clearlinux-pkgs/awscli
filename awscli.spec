...
Version  : 1.30.1
Release  : 1469
URL      : https://files.pythonhosted.org/packages/71/38/30fbb21806e0b9e295f6dc0aa86e06aac38a4e1f0533d972280369b09d5b/awscli-1.30.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/71/38/30fbb21806e0b9e295f6dc0aa86e06aac38a4e1f0533d972280369b09d5b/awscli-1.30.1.tar.gz
...
%prep
%setup -q -n awscli-1.30.1
cd %{_builddir}/awscli-1.30.1
pushd ..
cp -a awscli-1.30.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700093273
