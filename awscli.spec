...
Source0  : https://files.pythonhosted.org/packages/e6/c7/2a595b4fb638f9903cc144e00a033475684658397fd37d32a9e9b4bd4b7b/awscli-1.22.30.tar.gz
...
%prep
%setup -q -n awscli-1.22.30
cd %{_builddir}/awscli-1.22.30
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641502185
...
cp %{_builddir}/awscli-1.22.30/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
