...
Version  : 1.27.89
Release  : 1301
URL      : https://files.pythonhosted.org/packages/a3/8a/ac78d3b0b19f2de0e58bffe93ccfada335cd49495b2427423f9f7ca66f36/awscli-1.27.89.tar.gz
Source0  : https://files.pythonhosted.org/packages/a3/8a/ac78d3b0b19f2de0e58bffe93ccfada335cd49495b2427423f9f7ca66f36/awscli-1.27.89.tar.gz
...
%prep
%setup -q -n awscli-1.27.89
cd %{_builddir}/awscli-1.27.89
%patch1 -p1
pushd ..
cp -a awscli-1.27.89 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678481177
