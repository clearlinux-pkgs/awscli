...
Version  : 1.25.55
Release  : 1158
URL      : https://files.pythonhosted.org/packages/9b/8f/6cf1d01b8b9cea4c5c023897d9bc77b6adc1e0f365fe6d34c6a0df502c51/awscli-1.25.55.tar.gz
Source0  : https://files.pythonhosted.org/packages/9b/8f/6cf1d01b8b9cea4c5c023897d9bc77b6adc1e0f365fe6d34c6a0df502c51/awscli-1.25.55.tar.gz
...
%prep
%setup -q -n awscli-1.25.55
cd %{_builddir}/awscli-1.25.55
%patch1 -p1
pushd ..
cp -a awscli-1.25.55 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660786904
