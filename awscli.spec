...
%prep
%setup -q -n awscli-1.18.88
cd %{_builddir}/awscli-1.18.88
...
cp %{_builddir}/awscli-1.18.88/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
