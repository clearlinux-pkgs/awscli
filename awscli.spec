...
Source0  : https://files.pythonhosted.org/packages/8e/27/f03c2fc6fc558810755c2bc19d94a7512963a02fb2eccf3e3aa63e4e2bf6/awscli-1.25.50.tar.gz
...
%prep
%setup -q -n awscli-1.25.50
cd %{_builddir}/awscli-1.25.50
%patch1 -p1
pushd ..
cp -a awscli-1.25.50 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660247082
