...
Version  : 1.27.72
Release  : 1284
URL      : https://files.pythonhosted.org/packages/ef/0a/280c325f91e23922edc5240543ecddd3533d45a203dc477d46978c308774/awscli-1.27.72.tar.gz
Source0  : https://files.pythonhosted.org/packages/ef/0a/280c325f91e23922edc5240543ecddd3533d45a203dc477d46978c308774/awscli-1.27.72.tar.gz
...
%prep
%setup -q -n awscli-1.27.72
cd %{_builddir}/awscli-1.27.72
%patch1 -p1
pushd ..
cp -a awscli-1.27.72 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676504288
