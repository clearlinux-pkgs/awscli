...
Version  : 1.22.28
Release  : 999
URL      : https://files.pythonhosted.org/packages/62/3c/6546d258e0cd4953dacd5649d97f28e2cde088bf9d55bb6715dfcadc5465/awscli-1.22.28.tar.gz
Source0  : https://files.pythonhosted.org/packages/62/3c/6546d258e0cd4953dacd5649d97f28e2cde088bf9d55bb6715dfcadc5465/awscli-1.22.28.tar.gz
...
%prep
%setup -q -n awscli-1.22.28
cd %{_builddir}/awscli-1.22.28
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641330105
...
cp %{_builddir}/awscli-1.22.28/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
