...
Version  : 1.22.76
Release  : 1049
URL      : https://files.pythonhosted.org/packages/1c/8b/94df253eea422884869ac132cce5b8043e19c127ecfcfcd97a747ddee937/awscli-1.22.76.tar.gz
Source0  : https://files.pythonhosted.org/packages/1c/8b/94df253eea422884869ac132cce5b8043e19c127ecfcfcd97a747ddee937/awscli-1.22.76.tar.gz
...
%prep
%setup -q -n awscli-1.22.76
cd %{_builddir}/awscli-1.22.76
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647525307
...
cp %{_builddir}/awscli-1.22.76/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
