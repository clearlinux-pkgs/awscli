...
Source0  : https://files.pythonhosted.org/packages/37/90/9a3bb4a6c2a6760c1d84d8ce4c02693ece9a6b7c8b5c3fb9d42ca45f90fc/awscli-1.25.70.tar.gz
...
%prep
%setup -q -n awscli-1.25.70
cd %{_builddir}/awscli-1.25.70
%patch1 -p1
pushd ..
cp -a awscli-1.25.70 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662677065
