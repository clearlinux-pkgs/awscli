...
Version  : 1.20.25
Release  : 913
URL      : https://files.pythonhosted.org/packages/bd/40/2eb34d09a57e918ecd310cf3bcef48ff1b17f5c18f65555ab07f5affc013/awscli-1.20.25.tar.gz
Source0  : https://files.pythonhosted.org/packages/bd/40/2eb34d09a57e918ecd310cf3bcef48ff1b17f5c18f65555ab07f5affc013/awscli-1.20.25.tar.gz
...
%prep
%setup -q -n awscli-1.20.25
cd %{_builddir}/awscli-1.20.25
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629404394
...
cp %{_builddir}/awscli-1.20.25/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
