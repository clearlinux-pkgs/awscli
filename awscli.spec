...
Version  : 1.18.31
Release  : 589
URL      : https://files.pythonhosted.org/packages/d4/03/2866c9a82166073896af063373d7d9dee30d87788791cfc338761962a0df/awscli-1.18.31.tar.gz
Source0  : https://files.pythonhosted.org/packages/d4/03/2866c9a82166073896af063373d7d9dee30d87788791cfc338761962a0df/awscli-1.18.31.tar.gz
...
%prep
%setup -q -n awscli-1.18.31
cd %{_builddir}/awscli-1.18.31
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585346027
...
cp %{_builddir}/awscli-1.18.31/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
