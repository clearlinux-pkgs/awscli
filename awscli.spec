...
Source0  : https://files.pythonhosted.org/packages/06/98/03c15230f97ac096c872d9596c37630a2cfa66e608bc45316d75f7b796cc/awscli-1.23.0.tar.gz
...
%prep
%setup -q -n awscli-1.23.0
cd %{_builddir}/awscli-1.23.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650917353
...
cp %{_builddir}/awscli-1.23.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
