...
Version  : 1.25.15
Release  : 1116
URL      : https://files.pythonhosted.org/packages/37/82/ed0647c837e19c60e35270543b0bac1b03680ad02929da87f74b96247af1/awscli-1.25.15.tar.gz
Source0  : https://files.pythonhosted.org/packages/37/82/ed0647c837e19c60e35270543b0bac1b03680ad02929da87f74b96247af1/awscli-1.25.15.tar.gz
...
%prep
%setup -q -n awscli-1.25.15
cd %{_builddir}/awscli-1.25.15
%patch1 -p1
pushd ..
cp -a awscli-1.25.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655926746
...
cp %{_builddir}/awscli-1.25.15/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
