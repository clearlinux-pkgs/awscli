...
Version  : 1.17.9
Release  : 549
URL      : https://files.pythonhosted.org/packages/79/ec/705804ff224296b4fbc289729e0d03573773926f58e0de1205f2118409d9/awscli-1.17.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/79/ec/705804ff224296b4fbc289729e0d03573773926f58e0de1205f2118409d9/awscli-1.17.9.tar.gz
...
%prep
%setup -q -n awscli-1.17.9
cd %{_builddir}/awscli-1.17.9
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579907795
...
cp %{_builddir}/awscli-1.17.9/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/e42b85dcbe49e5aa66fe2117f92a60f4c39666d5
