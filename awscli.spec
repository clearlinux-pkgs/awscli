...
Version  : 1.20.39
Release  : 920
URL      : https://files.pythonhosted.org/packages/cf/34/db8ef35e8c0b5376c17dddbf956897a7aa8d8de8ca59be9dfa3723c751d9/awscli-1.20.39.tar.gz
Source0  : https://files.pythonhosted.org/packages/cf/34/db8ef35e8c0b5376c17dddbf956897a7aa8d8de8ca59be9dfa3723c751d9/awscli-1.20.39.tar.gz
...
%prep
%setup -q -n awscli-1.20.39
cd %{_builddir}/awscli-1.20.39
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631220896
...
cp %{_builddir}/awscli-1.20.39/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
