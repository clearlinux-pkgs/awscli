...
Version  : 1.27.137
Release  : 1349
URL      : https://files.pythonhosted.org/packages/9b/2a/3161a064cfadae36f7df7c9e75a5bcadacba72fa29ef6c14c96b2ee00f27/awscli-1.27.137.tar.gz
Source0  : https://files.pythonhosted.org/packages/9b/2a/3161a064cfadae36f7df7c9e75a5bcadacba72fa29ef6c14c96b2ee00f27/awscli-1.27.137.tar.gz
...
%prep
%setup -q -n awscli-1.27.137
cd %{_builddir}/awscli-1.27.137
%patch1 -p1
pushd ..
cp -a awscli-1.27.137 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684525665
