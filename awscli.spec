...
Source0  : https://files.pythonhosted.org/packages/5b/6d/bea374bdbd5ed9f570fdd9fa7d44193c7f6d1d4acba72651ec23191736b9/awscli-1.29.64.tar.gz
...
%prep
%setup -q -n awscli-1.29.64
cd %{_builddir}/awscli-1.29.64
pushd ..
cp -a awscli-1.29.64 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697490498
