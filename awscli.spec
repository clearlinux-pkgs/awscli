...
Version  : 1.26.5
Release  : 1210
URL      : https://files.pythonhosted.org/packages/b2/7a/de75d2f021886ca9f2e6931a9d4e8a3b57024eb6fcde5ef59a830df70282/awscli-1.26.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/b2/7a/de75d2f021886ca9f2e6931a9d4e8a3b57024eb6fcde5ef59a830df70282/awscli-1.26.5.tar.gz
...
%prep
%setup -q -n awscli-1.26.5
cd %{_builddir}/awscli-1.26.5
%patch1 -p1
pushd ..
cp -a awscli-1.26.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667245495
