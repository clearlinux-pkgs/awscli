...
Version  : 1.25.14
Release  : 1115
URL      : https://files.pythonhosted.org/packages/b6/a4/cdc2a15014ec1afb3a1df7756a808daa6398d53a2aab3e86bc4fced39bea/awscli-1.25.14.tar.gz
Source0  : https://files.pythonhosted.org/packages/b6/a4/cdc2a15014ec1afb3a1df7756a808daa6398d53a2aab3e86bc4fced39bea/awscli-1.25.14.tar.gz
...
%prep
%setup -q -n awscli-1.25.14
cd %{_builddir}/awscli-1.25.14
%patch1 -p1
pushd ..
cp -a awscli-1.25.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655841048
...
cp %{_builddir}/awscli-1.25.14/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
