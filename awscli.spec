...
Version  : 1.25.26
Release  : 1127
URL      : https://files.pythonhosted.org/packages/15/5f/d35607f7d01b12bcae79f46ed3615d65f1735663db6ba669ed87534452b6/awscli-1.25.26.tar.gz
Source0  : https://files.pythonhosted.org/packages/15/5f/d35607f7d01b12bcae79f46ed3615d65f1735663db6ba669ed87534452b6/awscli-1.25.26.tar.gz
...
%prep
%setup -q -n awscli-1.25.26
cd %{_builddir}/awscli-1.25.26
%patch1 -p1
pushd ..
cp -a awscli-1.25.26 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657319848
...
cp %{_builddir}/awscli-1.25.26/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
