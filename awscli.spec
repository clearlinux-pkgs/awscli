...
Version  : 1.27.37
Release  : 1249
URL      : https://files.pythonhosted.org/packages/5d/6b/6780b3d9d840c404e9c42a30d8611caacee5846b64aed3a618aa4957fe01/awscli-1.27.37.tar.gz
Source0  : https://files.pythonhosted.org/packages/5d/6b/6780b3d9d840c404e9c42a30d8611caacee5846b64aed3a618aa4957fe01/awscli-1.27.37.tar.gz
...
%prep
%setup -q -n awscli-1.27.37
cd %{_builddir}/awscli-1.27.37
%patch1 -p1
pushd ..
cp -a awscli-1.27.37 buildavx2
cp -a awscli-1.27.37 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671838610
