...
Version  : 1.25.89
Release  : 1194
URL      : https://files.pythonhosted.org/packages/d9/fe/057ddb3194a7cdc69d04e41fb2c20834f69302ebd11ef2e05db0919fd3c2/awscli-1.25.89.tar.gz
Source0  : https://files.pythonhosted.org/packages/d9/fe/057ddb3194a7cdc69d04e41fb2c20834f69302ebd11ef2e05db0919fd3c2/awscli-1.25.89.tar.gz
...
%prep
%setup -q -n awscli-1.25.89
cd %{_builddir}/awscli-1.25.89
%patch1 -p1
pushd ..
cp -a awscli-1.25.89 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665087265
