...
Version  : 1.22.7
Release  : 973
URL      : https://files.pythonhosted.org/packages/4f/16/c78944d26d76f427dfaaaff443ef19b123bcf18a31d526c19989d04be4fa/awscli-1.22.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/4f/16/c78944d26d76f427dfaaaff443ef19b123bcf18a31d526c19989d04be4fa/awscli-1.22.7.tar.gz
...
%prep
%setup -q -n awscli-1.22.7
cd %{_builddir}/awscli-1.22.7
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637095971
...
cp %{_builddir}/awscli-1.22.7/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
