...
Source0  : https://files.pythonhosted.org/packages/b0/ad/4916bfa9789428c5c801467f8281d8eb82fda620ba0e7c2dee803df94195/awscli-1.20.20.tar.gz
...
%prep
%setup -q -n awscli-1.20.20
cd %{_builddir}/awscli-1.20.20
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628805563
...
cp %{_builddir}/awscli-1.20.20/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
