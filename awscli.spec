...
Source0  : https://files.pythonhosted.org/packages/2e/d1/2328a928e88c3cc77889c4b4d2b7e8c3ba12ba1953f4ad416ac1816d5407/awscli-1.27.68.tar.gz
...
%prep
%setup -q -n awscli-1.27.68
cd %{_builddir}/awscli-1.27.68
%patch1 -p1
pushd ..
cp -a awscli-1.27.68 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675975397
