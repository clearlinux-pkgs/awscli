...
Source0  : https://files.pythonhosted.org/packages/a1/47/62bc1b8ca03cad2de9c053f644c8e4f0f1bcc1633cbf695b790fe09c75bd/awscli-1.25.90.tar.gz
...
%prep
%setup -q -n awscli-1.25.90
cd %{_builddir}/awscli-1.25.90
%patch1 -p1
pushd ..
cp -a awscli-1.25.90 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665172181
