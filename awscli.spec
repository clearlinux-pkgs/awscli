...
Source0  : https://files.pythonhosted.org/packages/a3/1b/b69a8d40871f7ee97625dd9ca9b8aaf4849f7f40d465d470b2e0bfbbbfc8/awscli-1.22.80.tar.gz
...
%prep
%setup -q -n awscli-1.22.80
cd %{_builddir}/awscli-1.22.80
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648143643
...
cp %{_builddir}/awscli-1.22.80/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
