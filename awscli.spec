...
Version  : 1.25.27
Release  : 1128
URL      : https://files.pythonhosted.org/packages/07/0a/8ca8d5ec5c9a3b71cadb13d9cdff29b73f913dd85fd021e4d38679576137/awscli-1.25.27.tar.gz
Source0  : https://files.pythonhosted.org/packages/07/0a/8ca8d5ec5c9a3b71cadb13d9cdff29b73f913dd85fd021e4d38679576137/awscli-1.25.27.tar.gz
...
%prep
%setup -q -n awscli-1.25.27
cd %{_builddir}/awscli-1.25.27
%patch1 -p1
pushd ..
cp -a awscli-1.25.27 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657568381
...
cp %{_builddir}/awscli-1.25.27/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
