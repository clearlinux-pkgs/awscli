...
Version  : 1.19.38
Release  : 814
URL      : https://files.pythonhosted.org/packages/4a/7d/9e2cea20d82c7b60d9571643d80fdd1fb7dfbe0f146e258e8e3305edc2d3/awscli-1.19.38.tar.gz
Source0  : https://files.pythonhosted.org/packages/4a/7d/9e2cea20d82c7b60d9571643d80fdd1fb7dfbe0f146e258e8e3305edc2d3/awscli-1.19.38.tar.gz
...
%prep
%setup -q -n awscli-1.19.38
cd %{_builddir}/awscli-1.19.38
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616767372
...
cp %{_builddir}/awscli-1.19.38/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
