...
Version  : 1.25.42
Release  : 1144
URL      : https://files.pythonhosted.org/packages/47/0a/a7375848e0ed1c72b1009dee736781bc279f2ca7a214a9859d0accee0d0a/awscli-1.25.42.tar.gz
Source0  : https://files.pythonhosted.org/packages/47/0a/a7375848e0ed1c72b1009dee736781bc279f2ca7a214a9859d0accee0d0a/awscli-1.25.42.tar.gz
...
%prep
%setup -q -n awscli-1.25.42
cd %{_builddir}/awscli-1.25.42
%patch1 -p1
pushd ..
cp -a awscli-1.25.42 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659221310
