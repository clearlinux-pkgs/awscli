...
Version  : 1.25.19
Release  : 1120
URL      : https://files.pythonhosted.org/packages/4e/3b/bcac557894899672f24dfa3544a00d7d649cac415711188b5becfbfc385f/awscli-1.25.19.tar.gz
Source0  : https://files.pythonhosted.org/packages/4e/3b/bcac557894899672f24dfa3544a00d7d649cac415711188b5becfbfc385f/awscli-1.25.19.tar.gz
...
%prep
%setup -q -n awscli-1.25.19
cd %{_builddir}/awscli-1.25.19
%patch1 -p1
pushd ..
cp -a awscli-1.25.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656446276
...
cp %{_builddir}/awscli-1.25.19/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
