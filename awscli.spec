...
Version  : 1.27.18
Release  : 1230
URL      : https://files.pythonhosted.org/packages/07/01/b244062fd76231290b1956ba15045067a9d81f86a39f256feef19dce00c9/awscli-1.27.18.tar.gz
Source0  : https://files.pythonhosted.org/packages/07/01/b244062fd76231290b1956ba15045067a9d81f86a39f256feef19dce00c9/awscli-1.27.18.tar.gz
...
%prep
%setup -q -n awscli-1.27.18
cd %{_builddir}/awscli-1.27.18
%patch1 -p1
pushd ..
cp -a awscli-1.27.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669710929
