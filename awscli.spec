...
Version  : 1.27.46
Release  : 1258
URL      : https://files.pythonhosted.org/packages/01/46/c027668b84a7256ebaa086dbdaf96bce9743d0bb5fd79aaacf9fad59c4aa/awscli-1.27.46.tar.gz
Source0  : https://files.pythonhosted.org/packages/01/46/c027668b84a7256ebaa086dbdaf96bce9743d0bb5fd79aaacf9fad59c4aa/awscli-1.27.46.tar.gz
...
%prep
%setup -q -n awscli-1.27.46
cd %{_builddir}/awscli-1.27.46
%patch1 -p1
pushd ..
cp -a awscli-1.27.46 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673297481
