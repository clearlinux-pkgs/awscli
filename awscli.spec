...
Version  : 1.25.7
Release  : 1108
URL      : https://files.pythonhosted.org/packages/ed/08/c6f08a69faf438a5e8b4f3253a90d7775dbe7207f1bdd5898765901de351/awscli-1.25.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/ed/08/c6f08a69faf438a5e8b4f3253a90d7775dbe7207f1bdd5898765901de351/awscli-1.25.7.tar.gz
...
%prep
%setup -q -n awscli-1.25.7
cd %{_builddir}/awscli-1.25.7
%patch1 -p1
pushd ..
cp -a awscli-1.25.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654900836
...
cp %{_builddir}/awscli-1.25.7/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
