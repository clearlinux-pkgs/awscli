...
Version  : 1.27.61
Release  : 1273
URL      : https://files.pythonhosted.org/packages/80/03/675e740fd38a130ba4f02b8235289689630541da5809225b46f2797d2656/awscli-1.27.61.tar.gz
Source0  : https://files.pythonhosted.org/packages/80/03/675e740fd38a130ba4f02b8235289689630541da5809225b46f2797d2656/awscli-1.27.61.tar.gz
...
%prep
%setup -q -n awscli-1.27.61
cd %{_builddir}/awscli-1.27.61
%patch1 -p1
pushd ..
cp -a awscli-1.27.61 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675198972
