...
Source0  : https://files.pythonhosted.org/packages/83/ae/20dee06bafa3af0592c1ada96394856f51319565446eef98143a69335700/awscli-1.27.20.tar.gz
...
%prep
%setup -q -n awscli-1.27.20
cd %{_builddir}/awscli-1.27.20
%patch1 -p1
pushd ..
cp -a awscli-1.27.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669841809
