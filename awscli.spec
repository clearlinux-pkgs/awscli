...
Version  : 1.25.4
Release  : 1105
URL      : https://files.pythonhosted.org/packages/32/72/8d10199de6384eb8a91d60e563558aacd4ca8a3d420443a0246b8a775997/awscli-1.25.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/32/72/8d10199de6384eb8a91d60e563558aacd4ca8a3d420443a0246b8a775997/awscli-1.25.4.tar.gz
...
%prep
%setup -q -n awscli-1.25.4
cd %{_builddir}/awscli-1.25.4
%patch1 -p1
pushd ..
cp -a awscli-1.25.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654630675
...
cp %{_builddir}/awscli-1.25.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
