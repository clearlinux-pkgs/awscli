...
Version  : 1.25.97
Release  : 1203
URL      : https://files.pythonhosted.org/packages/27/1e/b0f6ceba5f5ccf0e77f19d5cc9190ed5e0482949b35bec241d3e1d6237a2/awscli-1.25.97.tar.gz
Source0  : https://files.pythonhosted.org/packages/27/1e/b0f6ceba5f5ccf0e77f19d5cc9190ed5e0482949b35bec241d3e1d6237a2/awscli-1.25.97.tar.gz
...
%prep
%setup -q -n awscli-1.25.97
cd %{_builddir}/awscli-1.25.97
%patch1 -p1
pushd ..
cp -a awscli-1.25.97 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666392116
