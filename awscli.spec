...
Version  : 1.27.133
Release  : 1345
URL      : https://files.pythonhosted.org/packages/14/a7/598a35d7700340101e48446980ef8c2a17cd225e54fb67ec529c159c4233/awscli-1.27.133.tar.gz
Source0  : https://files.pythonhosted.org/packages/14/a7/598a35d7700340101e48446980ef8c2a17cd225e54fb67ec529c159c4233/awscli-1.27.133.tar.gz
...
%prep
%setup -q -n awscli-1.27.133
cd %{_builddir}/awscli-1.27.133
%patch1 -p1
pushd ..
cp -a awscli-1.27.133 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683834448
