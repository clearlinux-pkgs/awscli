...
Version  : 1.25.28
Release  : 1129
URL      : https://files.pythonhosted.org/packages/8c/7d/d555ebbc1c52135a5990245d83c3b14c0862827e4bd61a6b2eacae832e34/awscli-1.25.28.tar.gz
Source0  : https://files.pythonhosted.org/packages/8c/7d/d555ebbc1c52135a5990245d83c3b14c0862827e4bd61a6b2eacae832e34/awscli-1.25.28.tar.gz
...
%prep
%setup -q -n awscli-1.25.28
cd %{_builddir}/awscli-1.25.28
%patch1 -p1
pushd ..
cp -a awscli-1.25.28 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657665744
...
cp %{_builddir}/awscli-1.25.28/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
