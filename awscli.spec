...
Version  : 1.18.2
Release  : 559
URL      : https://files.pythonhosted.org/packages/68/64/5ae92cc231111de2e22eb58afb47dfcff943bd201f8cbc86ded89f9243b8/awscli-1.18.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/68/64/5ae92cc231111de2e22eb58afb47dfcff943bd201f8cbc86ded89f9243b8/awscli-1.18.2.tar.gz
...
%prep
%setup -q -n awscli-1.18.2
cd %{_builddir}/awscli-1.18.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582074687
...
cp %{_builddir}/awscli-1.18.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
