...
Source0  : https://files.pythonhosted.org/packages/87/d7/89985927c4d8cc43a541ebeac5e90de70d36a46843a0cb9fd4a59b8a835d/awscli-1.27.40.tar.gz
...
%prep
%setup -q -n awscli-1.27.40
cd %{_builddir}/awscli-1.27.40
%patch1 -p1
pushd ..
cp -a awscli-1.27.40 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672346255
