...
Source0  : https://files.pythonhosted.org/packages/f3/a8/ef5210c53c29ad65b2f42d41d2e27b19cf94f3acb36e31bb639b93312613/awscli-1.18.108.tar.gz
...
%prep
%setup -q -n awscli-1.18.108
cd %{_builddir}/awscli-1.18.108
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596058386
...
cp %{_builddir}/awscli-1.18.108/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
