...
Version  : 1.25.5
Release  : 1106
URL      : https://files.pythonhosted.org/packages/0e/bc/9dbb54a6b721eaed6479b5a10c96993836d5b0b76c8b070cd2417464d194/awscli-1.25.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/0e/bc/9dbb54a6b721eaed6479b5a10c96993836d5b0b76c8b070cd2417464d194/awscli-1.25.5.tar.gz
...
%prep
%setup -q -n awscli-1.25.5
cd %{_builddir}/awscli-1.25.5
%patch1 -p1
pushd ..
cp -a awscli-1.25.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654728040
...
cp %{_builddir}/awscli-1.25.5/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
