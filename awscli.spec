...
Version  : 1.19.77
Release  : 852
URL      : https://files.pythonhosted.org/packages/d7/77/772f4adda09fbb608223cd33a0aa81e66a6e11407cd8f91a54623a789873/awscli-1.19.77.tar.gz
Source0  : https://files.pythonhosted.org/packages/d7/77/772f4adda09fbb608223cd33a0aa81e66a6e11407cd8f91a54623a789873/awscli-1.19.77.tar.gz
...
%prep
%setup -q -n awscli-1.19.77
cd %{_builddir}/awscli-1.19.77
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621556153
...
cp %{_builddir}/awscli-1.19.77/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
