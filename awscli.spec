...
Version  : 1.18.1
Release  : 558
URL      : https://files.pythonhosted.org/packages/8d/1c/fd34ffea396935298dc7e8e5b2cc459bba74b25828d9276873352965a5f6/awscli-1.18.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/8d/1c/fd34ffea396935298dc7e8e5b2cc459bba74b25828d9276873352965a5f6/awscli-1.18.1.tar.gz
...
%prep
%setup -q -n awscli-1.18.1
cd %{_builddir}/awscli-1.18.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581987571
...
cp %{_builddir}/awscli-1.18.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
