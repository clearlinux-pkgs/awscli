...
Version  : 1.25.32
Release  : 1133
URL      : https://files.pythonhosted.org/packages/af/e6/89aefd4eb75caa4af91dce310879240cf7f3b290253b62fd4c97356e81fa/awscli-1.25.32.tar.gz
Source0  : https://files.pythonhosted.org/packages/af/e6/89aefd4eb75caa4af91dce310879240cf7f3b290253b62fd4c97356e81fa/awscli-1.25.32.tar.gz
...
%prep
%setup -q -n awscli-1.25.32
cd %{_builddir}/awscli-1.25.32
%patch1 -p1
pushd ..
cp -a awscli-1.25.32 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658181753
...
cp %{_builddir}/awscli-1.25.32/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
