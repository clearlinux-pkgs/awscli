...
Version  : 1.25.24
Release  : 1125
URL      : https://files.pythonhosted.org/packages/d1/1d/642fccb7041decb9a7cfbecfb057024233d5a05e5f29a3345149ae610dda/awscli-1.25.24.tar.gz
Source0  : https://files.pythonhosted.org/packages/d1/1d/642fccb7041decb9a7cfbecfb057024233d5a05e5f29a3345149ae610dda/awscli-1.25.24.tar.gz
...
%prep
%setup -q -n awscli-1.25.24
cd %{_builddir}/awscli-1.25.24
%patch1 -p1
pushd ..
cp -a awscli-1.25.24 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657136221
...
cp %{_builddir}/awscli-1.25.24/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
