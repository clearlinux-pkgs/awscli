...
Version  : 1.19.59
Release  : 834
URL      : https://files.pythonhosted.org/packages/d3/ef/db00eddf4ea493dc75e639d0f8ace9267c51b9a3bc26e710e224fa11d7da/awscli-1.19.59.tar.gz
Source0  : https://files.pythonhosted.org/packages/d3/ef/db00eddf4ea493dc75e639d0f8ace9267c51b9a3bc26e710e224fa11d7da/awscli-1.19.59.tar.gz
...
%prep
%setup -q -n awscli-1.19.59
cd %{_builddir}/awscli-1.19.59
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619560904
...
cp %{_builddir}/awscli-1.19.59/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
