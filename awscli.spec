...
Version  : 1.27.77
Release  : 1289
URL      : https://files.pythonhosted.org/packages/7e/e0/8da9d6b46911eadd236660220474b7960a37efc33a52ea8b8189ac7ae569/awscli-1.27.77.tar.gz
Source0  : https://files.pythonhosted.org/packages/7e/e0/8da9d6b46911eadd236660220474b7960a37efc33a52ea8b8189ac7ae569/awscli-1.27.77.tar.gz
...
%prep
%setup -q -n awscli-1.27.77
cd %{_builddir}/awscli-1.27.77
%patch1 -p1
pushd ..
cp -a awscli-1.27.77 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677098131
