...
Version  : 1.25.66
Release  : 1171
URL      : https://files.pythonhosted.org/packages/cb/aa/3eafd986adfb595ee22c755d27b315c10846956ed65713674532bd6ae32a/awscli-1.25.66.tar.gz
Source0  : https://files.pythonhosted.org/packages/cb/aa/3eafd986adfb595ee22c755d27b315c10846956ed65713674532bd6ae32a/awscli-1.25.66.tar.gz
...
%prep
%setup -q -n awscli-1.25.66
cd %{_builddir}/awscli-1.25.66
%patch1 -p1
pushd ..
cp -a awscli-1.25.66 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662063845
