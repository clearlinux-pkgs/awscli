...
Version  : 1.37.18
Release  : 1765
URL      : https://files.pythonhosted.org/packages/4f/05/f90116ed6d2a0b3eefb9036ee7e7a2fa5a926b73b783dbf582c54dc61d6b/awscli-1.37.18.tar.gz
Source0  : https://files.pythonhosted.org/packages/4f/05/f90116ed6d2a0b3eefb9036ee7e7a2fa5a926b73b783dbf582c54dc61d6b/awscli-1.37.18.tar.gz
...
%prep
%setup -q -n awscli-1.37.18
cd %{_builddir}/awscli-1.37.18
pushd ..
cp -a awscli-1.37.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739317417
