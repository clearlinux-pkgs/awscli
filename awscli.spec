...
Version  : 1.25.71
Release  : 1176
URL      : https://files.pythonhosted.org/packages/e3/ed/ae6f7bae61d5c13607eac8430a2471c3eb0fce2bc12d61cd9e632bad49d9/awscli-1.25.71.tar.gz
Source0  : https://files.pythonhosted.org/packages/e3/ed/ae6f7bae61d5c13607eac8430a2471c3eb0fce2bc12d61cd9e632bad49d9/awscli-1.25.71.tar.gz
...
%prep
%setup -q -n awscli-1.25.71
cd %{_builddir}/awscli-1.25.71
%patch1 -p1
pushd ..
cp -a awscli-1.25.71 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662752596
