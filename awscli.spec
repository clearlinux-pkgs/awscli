...
Version  : 1.25.25
Release  : 1126
URL      : https://files.pythonhosted.org/packages/2e/05/bacdf7f303485cad3cb3c53ebf8f49042406adb0b4ecf0830984980b21de/awscli-1.25.25.tar.gz
Source0  : https://files.pythonhosted.org/packages/2e/05/bacdf7f303485cad3cb3c53ebf8f49042406adb0b4ecf0830984980b21de/awscli-1.25.25.tar.gz
...
%prep
%setup -q -n awscli-1.25.25
cd %{_builddir}/awscli-1.25.25
%patch1 -p1
pushd ..
cp -a awscli-1.25.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657244567
...
cp %{_builddir}/awscli-1.25.25/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
