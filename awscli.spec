...
Version  : 1.17.6
Release  : 546
URL      : https://files.pythonhosted.org/packages/0a/dc/a7396a2c06e563efda5776d75fc2e9d40553a58951479807262360f6fb35/awscli-1.17.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/0a/dc/a7396a2c06e563efda5776d75fc2e9d40553a58951479807262360f6fb35/awscli-1.17.6.tar.gz
...
%prep
%setup -q -n awscli-1.17.6
cd %{_builddir}/awscli-1.17.6
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579623818
...
cp %{_builddir}/awscli-1.17.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/e42b85dcbe49e5aa66fe2117f92a60f4c39666d5
