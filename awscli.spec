...
Source0  : https://files.pythonhosted.org/packages/59/51/23730328c43354f50e9d07be07d98366aefddcf05a5a671f6f2c2a641ba7/awscli-1.25.20.tar.gz
...
%prep
%setup -q -n awscli-1.25.20
cd %{_builddir}/awscli-1.25.20
%patch1 -p1
pushd ..
cp -a awscli-1.25.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656531975
...
cp %{_builddir}/awscli-1.25.20/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
