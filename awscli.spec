...
Version  : 1.24.9
Release  : 1099
URL      : https://files.pythonhosted.org/packages/b8/6a/dc011795b423c2fdcce6f55470bebe1422cce1d6bb4815fab858b92dff59/awscli-1.24.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/b8/6a/dc011795b423c2fdcce6f55470bebe1422cce1d6bb4815fab858b92dff59/awscli-1.24.9.tar.gz
...
%prep
%setup -q -n awscli-1.24.9
cd %{_builddir}/awscli-1.24.9
%patch1 -p1
pushd ..
cp -a awscli-1.24.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653605094
...
cp %{_builddir}/awscli-1.24.9/LICENSE.txt %{buildroot}/usr/share/package-licenses/awscli/4be62be059d3caeb4224228692644230d266368b
