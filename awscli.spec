...
Version  : 1.25.61
Release  : 1166
URL      : https://files.pythonhosted.org/packages/39/09/7638d2ef9a5f84936f8c28766635bfefa325beafbec265a077f71a26959a/awscli-1.25.61.tar.gz
Source0  : https://files.pythonhosted.org/packages/39/09/7638d2ef9a5f84936f8c28766635bfefa325beafbec265a077f71a26959a/awscli-1.25.61.tar.gz
...
%prep
%setup -q -n awscli-1.25.61
cd %{_builddir}/awscli-1.25.61
%patch1 -p1
pushd ..
cp -a awscli-1.25.61 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661466986
